...
describe('Login Scenarios', () => {
  ...
  describe('Scenario 1: Normal login with venues', () => {
    ...
    it('should select first venue by default', async () => {
      ...
      expect(mockJwtService.generateAccessToken).toHaveBeenCalledWith('staff-1', 'org-1', 'venue-1', StaffRole.ADMIN, undefined, { sid: expect.any(String) })
    })
  })
  ...
  describe('Scenario 2: Login with specific venueId', () => {
    it('should login to specified venue', async () => {
      ...
      expect(mockJwtService.generateAccessToken).toHaveBeenCalledWith('staff-1', 'org-1', 'venue-2', StaffRole.CASHIER, undefined, { sid: expect.any(String) })
    })
  ...
  describe('Scenario 13: Multi-org user login', () => {
    ...
    it('should login to specific venue in second organization', async () => {
      ...
      expect(mockJwtService.generateAccessToken).toHaveBeenCalledWith('staff-1', 'org-2', 'venue-org2', StaffRole.MANAGER, undefined, { sid: expect.any(String) })
    })
  })
