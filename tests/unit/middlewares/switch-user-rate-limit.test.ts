 ...
 */
import { __llaveDeAparatoParaPruebas as llaveDeAparato } from '../../../src/middlewares/pin-login-rate-limit.middleware'

const req = (headers: Record<string, string>, ip = '10.0.0.1') =>
  ({ get: (h: string) => headers[h.toLowerCase()], ip, socket: { remoteAddress: ip } }) as never
