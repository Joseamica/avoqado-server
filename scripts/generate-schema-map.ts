...
const DOMAINS: Domain[] = [
  {
    ...
    description:
      'The org/venue tree + physical floor layout. The root every other table hangs off.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Stock on hand, raw materials, recipes, suppliers, purchase orders, FIFO batches.',
  },
  {
    name: 'Serialized Inventory',
    description:
      'Unique-barcode items (SIM cards etc.) with chain-of-custody + post-payment verification.',
  },
  {
    name: 'Orders, KDS & Cash',
    description:
      'The order lifecycle, kitchen display, shifts, and cash drawer / corte de caja.',
  },
  {
    name: 'Payments & Fees',
  ...
  },
  {
    ...
    description:
      'Blumon / Stripe / MercadoPago / AngelPay merchant accounts, webhooks, settlement.',
  },
  {
    name: 'Payment Links',
  ...
  },
  {
    ...
    description:
      'MCC pricing structures, monthly profit, and SOFOM-style venue credit assessment.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Sales-rep commission tiers, payouts, clawbacks, org goals (CommandCenter).',
  },
  {
  ...
  },
  {
    ...
    description:
      'PAX terminal fleet: health, logs, app updates, remote commands, messaging.',
  },
  {
    name: 'Notifications, WhatsApp & Marketing',
    description:
      'Outbound notifications, WhatsApp venue-chat relay, mass-email campaigns.',
  },
  {
    name: 'AI Chatbot (Text-to-SQL)',
    description:
      'The in-dashboard AI assistant: conversations, training data, learned patterns.',
  },
  {
    name: 'Customers, Consumers & Reviews',
    description:
      'End-customer identity (venue customers + cross-venue Consumers) and reviews.',
  },
  {
    name: 'System: Audit, Webhooks & Platform',
    description:
      'Cross-cutting plumbing: audit log, webhook subscriptions, partner API keys, global settings.',
  },
]
...
function main() {
  ...
  if (checkMode) {
    ...
    console.log(
      `✅ docs/SCHEMA_MAP.md is up to date (${modelNames.length} models, ${parsed.enumCount} enums).`,
    )
    process.exit(0)
  }
  ...
  console.log(
    `✅ Regenerated docs/SCHEMA_MAP.md — ${modelNames.length} models, ` +
      `${parsed.enumCount} enums, ${parsed.lineCount} lines.`,
  )
}
