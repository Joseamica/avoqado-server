...
CREATE INDEX CONCURRENTLY "SerializedItem_organizationId_registeredFromVenueId_createdAt_id_idx" ON "SerializedItem"("organizationId", "registeredFromVenueId", "createdAt" DESC, "id" DESC);
