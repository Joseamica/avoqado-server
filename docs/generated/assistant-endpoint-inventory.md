...
- DELETE `/api/v1/dashboard/notifications` — dangerousMutation; permissions: none; controller: notificationController.deleteAllNotifications
...
| GET | `/api/v1/dashboard/announcements/:id` | read | unknown | missing | - | - | announcementReadController.getDetail |
| POST | `/api/v1/dashboard/announcements/:id/cta` | action | unknown | missing | - | - | announcementReadController.cta |
| POST | `/api/v1/dashboard/announcements/:id/dismiss` | action | unknown | missing | - | - | announcementReadController.dismiss |
| POST | `/api/v1/dashboard/announcements/:id/open` | action | unknown | missing | - | - | announcementReadController.open |
| GET | `/api/v1/dashboard/announcements/home` | read | unknown | missing | - | - | announcementReadController.home |
...
| DELETE | `/api/v1/dashboard/notifications` | dangerousMutation | unknown | missing | - | - | notificationController.deleteAllNotifications |
...
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/access` | read | organization | missing | - | - | controller.getAccess |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/audit` | read | organization | missing | - | - | controller.listAudit |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/audit/actions` | read | organization | missing | - | - | controller.listAuditActions |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/bindings/confirm` | action | organization | missing | - | - | controller.confirmBindings |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/bindings/preview` | action | organization | missing | - | - | controller.previewBindings |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/brands` | read | organization | missing | - | - | controller.listBrands |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/brands` | action | organization | missing | - | - | controller.createBrand |
| PATCH | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/brands/:brandId` | mutation | organization | missing | - | - | controller.updateBrand |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/brands/:brandId/retire` | action | organization | missing | - | - | controller.retireBrand |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/families` | read | organization | missing | - | - | controller.listFamilies |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/families` | action | organization | missing | - | - | controller.createFamily |
| PATCH | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/families/:familyId` | mutation | organization | missing | - | - | controller.updateFamily |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/families/:familyId/retire` | action | organization | missing | - | - | controller.retireFamily |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/manufacturers` | read | organization | missing | - | - | controller.listManufacturers |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/manufacturers` | action | organization | missing | - | - | controller.createManufacturer |
| PATCH | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/manufacturers/:manufacturerId` | mutation | organization | missing | - | - | controller.updateManufacturer |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/catalogs/manufacturers/:manufacturerId/retire` | action | organization | missing | - | - | controller.retireManufacturer |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/exports/catalog-by-business-type.xlsx` | read | organization | missing | - | - | exportController.getCatalogBusinessTypeExport |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/exports/catalog-master.xlsx` | read | organization | missing | - | - | exportController.getCatalogMasterExport |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/imports/:importBatchId` | read | organization | missing | - | - | controller.getImport |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/imports/:importBatchId/confirm` | action | organization | missing | - | - | controller.confirmImport |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/imports/:importBatchId/errors.xlsx` | read | organization | missing | - | - | exportController.getCatalogImportErrors |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/imports/preview` | action | organization | missing | - | - | controller.previewImport |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/items` | read | organization | missing | - | - | controller.listItems |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/items` | action | organization | missing | - | - | controller.createItem |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/items/:catalogItemId` | read | organization | missing | - | - | controller.getItem |
| PATCH | `/api/v1/dashboard/organizations/:orgId/master-catalog/items/:catalogItemId` | mutation | organization | missing | - | - | controller.updateItem |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/items/:catalogItemId/retire` | action | organization | missing | - | - | controller.retireItem |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications` | public | public | blocked | - | - | controller.listPublications |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications/:publicationBatchId` | public | public | blocked | - | - | controller.getPublication |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications/:publicationBatchId/confirm` | public | public | blocked | - | - | controller.confirmPublication |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications/:publicationBatchId/reversal/preview` | public | public | blocked | - | - | controller.previewPublicationReversal |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications/by-idempotency-key/:operation/:idempotencyKey` | public | public | blocked | - | - | controller.getPublicationByIdempotencyKey |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/publications/preview` | public | public | blocked | - | - | controller.previewPublication |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/templates/catalog-master-import-v1.xlsx` | read | organization | missing | - | - | exportController.getCatalogImportTemplate |
| GET | `/api/v1/dashboard/organizations/:orgId/master-catalog/validation-profiles` | read | organization | missing | - | - | controller.listValidationProfiles |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/validation-profiles/:profileBatchId/confirm` | action | organization | missing | - | - | controller.confirmValidationProfile |
| POST | `/api/v1/dashboard/organizations/:orgId/master-catalog/validation-profiles/preview` | action | organization | missing | - | - | controller.previewValidationProfile |
...
| POST | `/api/v1/dashboard/organizations/:orgId/sim-custody/reassign-supervisor` | action | organization | missing | sim-custody:reassign-supervisor | - | reassignSupervisor |
...
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/bulk-groups` | read | organization | partial | - | - | getOrgStockBulkGroups |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/by-responsible` | read | organization | partial | - | - | getOrgInventoryByResponsible |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/custody` | read | organization | partial | - | - | getOrgStockCustody |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/export.xlsx` | read | organization | partial | - | - | exportOrgStockExcel |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/items` | read | organization | partial | - | - | getOrgStockItems |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/overview` | read | organization | partial | - | - | getOrgStockOverview |
| GET | `/api/v1/dashboard/organizations/:orgId/stock-control/summary` | read | organization | partial | - | - | getOrgStockSummary |
...
| GET | `/api/v1/dashboard/organizations/:orgId/supervisors` | read | organization | missing | - | - | (inline handler) |
...
| POST | `/api/v1/dashboard/organizations/:orgId/terminals/:terminalId/migrate-discard` | action | organization | missing | - | orgMigrateDiscardSchema | (inline handler) |
...
| GET | `/api/v1/dashboard/reports/promotions` | read | unknown | missing | reports:read | - | promotionSalesReport |
...
| GET | `/api/v1/dashboard/reports/venues/:venueId/promotions` | read | venue | missing | reports:read | - | promotionSalesReport |
...
| POST | `/api/v1/dashboard/superadmin/organizations/:organizationId/plan/grandfathered` | adminOnly | superadmin | blocked | - | setOrganizationGrandfatheredSchema | organizationController.setOrganizationPlanGrandfathered |
...
| POST | `/api/v1/dashboard/superadmin/terminals/:terminalId/migrate-discard` | adminOnly | superadmin | blocked | - | migrateDiscardSchema | migrationController.discard |
...
| POST | `/api/v1/dashboard/superadmin/terminals/payment-requests/:requestId/release` | adminOnly | superadmin | blocked | - | z.object | terminalController.releaseTerminalPaymentRequest |
...
| GET | `/api/v1/dashboard/venues/:venueId/accounting/expenses/export` | read | venue | missing | accounting:read | - | accountingExportController.exportExpenses |
...
| GET | `/api/v1/dashboard/venues/:venueId/accounting/trial-balance/export` | read | venue | missing | accounting:read | - | accountingExportController.exportTrialBalance |
...
| GET | `/api/v1/dashboard/venues/:venueId/activity-log/export` | read | venue | missing | activity:read | - | activityLogController.exportActivityLog |
| GET | `/api/v1/dashboard/venues/:venueId/analytics` | read | venue | partial | - | - | getAnalyticsData |
| GET | `/api/v1/dashboard/venues/:venueId/area-tickets` | read | venue | missing | area-tickets:configure | areaTicketOverviewSchema | controller.getOverview |
| POST | `/api/v1/dashboard/venues/:venueId/area-tickets/areas` | action | venue | missing | area-tickets:configure | createFulfillmentAreaSchema | controller.createArea |
| PUT | `/api/v1/dashboard/venues/:venueId/area-tickets/areas/:areaId` | mutation | venue | missing | area-tickets:configure | updateFulfillmentAreaSchema | controller.updateArea |
| GET | `/api/v1/dashboard/venues/:venueId/area-tickets/external-incidents` | read | venue | missing | area-tickets:configure | listExternalIncidentsSchema | controller.listExternalIncidents |
| GET | `/api/v1/dashboard/venues/:venueId/area-tickets/external-settlements` | read | public | partial | area-tickets:configure | listExternalSettlementsSchema | controller.listExternalSettlements |
| GET | `/api/v1/dashboard/venues/:venueId/area-tickets/operations` | read | venue | missing | area-tickets:deliver | areaTicketOverviewSchema | controller.getOperations |
| POST | `/api/v1/dashboard/venues/:venueId/area-tickets/scale-profiles` | action | venue | missing | scale:configure | createScaleProfileSchema | controller.createScaleProfile |
| PUT | `/api/v1/dashboard/venues/:venueId/area-tickets/scale-profiles/:profileId` | mutation | venue | missing | scale:configure | updateScaleProfileSchema | controller.updateScaleProfile |
| PUT | `/api/v1/dashboard/venues/:venueId/area-tickets/scale-settings` | mutation | venue | missing | scale:configure | updateScaleSettingsSchema | controller.updateScaleSettings |
| PUT | `/api/v1/dashboard/venues/:venueId/area-tickets/settings` | mutation | venue | missing | area-tickets:configure | updateAreaTicketSettingsSchema | controller.updateSettings |
| PUT | `/api/v1/dashboard/venues/:venueId/area-tickets/terminals/:terminalId` | mutation | venue | missing | area-tickets:configure | updateAreaTicketTerminalSchema | controller.updateTerminal |
| GET | `/api/v1/dashboard/venues/:venueId/attendance/payroll-summary` | read | venue | partial | attendance:read | PayrollSummarySchema | attendanceController.getPayrollSummary |
| GET | `/api/v1/dashboard/venues/:venueId/attendance/report` | read | venue | missing | attendance:read | AttendanceReportSchema | attendanceController.getReport |
...
| GET | `/api/v1/dashboard/venues/:venueId/basic-metrics/details` | read | venue | missing | analytics:read | z.object | generalStatsController.getBasicMetricsDetails |
...
| GET | `/api/v1/dashboard/venues/:venueId/birthday-automation` | read | venue | missing | marketing:manage | obtenerAutomatizacionSchema | controller.getBirthdayAutomation |
| PUT | `/api/v1/dashboard/venues/:venueId/birthday-automation` | mutation | venue | missing | - | guardarAutomatizacionSchema | controller.putBirthdayAutomation |
| GET | `/api/v1/dashboard/venues/:venueId/campaigns` | read | venue | missing | marketing:manage | listarCampanasSchema | controller.listCampaigns |
| POST | `/api/v1/dashboard/venues/:venueId/campaigns` | action | venue | missing | marketing:manage | crearCampanaSchema | controller.createCampaign |
| GET | `/api/v1/dashboard/venues/:venueId/campaigns/:id` | read | venue | missing | marketing:manage | campanaParamsSchema | controller.getCampaign |
| PUT | `/api/v1/dashboard/venues/:venueId/campaigns/:id` | mutation | venue | missing | marketing:manage | editarCampanaSchema | controller.updateCampaign |
| POST | `/api/v1/dashboard/venues/:venueId/campaigns/:id/preview` | action | venue | missing | marketing:manage | campanaParamsSchema | controller.previewCampaign |
| POST | `/api/v1/dashboard/venues/:venueId/campaigns/:id/publish` | action | venue | missing | marketing:send | publicarCampanaSchema | controller.publishCampaign |
...
| GET | `/api/v1/dashboard/venues/:venueId/cash-drawer/sessions` | read | venue | missing | shifts:read | - | cashDrawerController.getDrawerSessions |
| GET | `/api/v1/dashboard/venues/:venueId/cash-drawer/status` | read | venue | missing | shifts:read | - | cashDrawerController.getDrawerStatus |
...
| POST | `/api/v1/dashboard/venues/:venueId/credit-packs/balances/:balanceId/redeem` | action | venue | partial | creditPacks:redeem | redeemBodySchema | controller.redeemItem |
...
| PATCH | `/api/v1/dashboard/venues/:venueId/customers/:customerId/approval` | mutation | venue | partial | customers:approve | CustomerApprovalDecisionSchema | customerController.decideCustomerApproval |
...
| GET | `/api/v1/dashboard/venues/:venueId/customers/awaiting-approval` | read | venue | partial | customers:approve | CustomersAwaitingApprovalQuerySchema | customerController.getCustomersAwaitingApproval |
...
| GET | `/api/v1/dashboard/venues/:venueId/fiscal-profile` | read | venue | missing | venue-fiscal-profile:manage | venueParamSchema | controller.getFiscalProfile |
| PUT | `/api/v1/dashboard/venues/:venueId/fiscal-profile` | mutation | venue | missing | venue-fiscal-profile:manage | upsertFiscalProfileSchema | controller.upsertFiscalProfile |
| POST | `/api/v1/dashboard/venues/:venueId/fiscal-profile/constancia` | action | venue | missing | venue-fiscal-profile:manage | uploadConstanciaSchema | controller.uploadFiscalConstancia |
...
| GET | `/api/v1/dashboard/venues/:venueId/fiscal/emisores/:emisorId/provider-status` | read | venue | missing | cfdi:view | - | getEmisorProviderStatusController |
...
| PATCH | `/api/v1/dashboard/venues/:venueId/fulfillment-areas/:areaId/settlement-route` | mutation | public | partial | area-tickets:configure | updateAreaSettlementRouteSchema | areaTicketController.updateAreaSettlementRoute |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/batches/:batchId` | read | venue | partial | inventory:read | - | stockBatchController.getBatch |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/batches/:batchId/quarantine` | action | venue | partial | inventory:adjust | QuarantineBatchSchema | stockBatchController.quarantineBatch |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/batches/:batchId/release` | action | venue | partial | inventory:adjust | ReleaseBatchSchema | stockBatchController.releaseBatchFromQuarantine |
| GET | `/api/v1/dashboard/venues/:venueId/inventory/batches/stats` | read | venue | partial | inventory:read | - | stockBatchController.getBatchStatistics |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/adjust-stock` | action | venue | partial | inventory:adjust | AdjustProductInventoryStockSchema | productInventoryController.adjustInventoryStockHandler |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-invoices/:invoiceId/lines/:lineId/identify` | action | venue | partial | inventory:update | - | purchaseOrderInvoiceController.identifyLine |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/invoices` | read | venue | partial | inventory:read | - | purchaseOrderInvoiceController.listInvoices |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/invoices` | action | venue | partial | inventory:update | - | purchaseOrderInvoiceController.attachInvoice |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/reject` | action | venue | partial | inventory:update | RejectPurchaseOrderSchema | purchaseOrderController.rejectPurchaseOrder |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/submit-for-approval` | action | venue | partial | inventory:update | - | purchaseOrderController.submitPurchaseOrderForApproval |
| GET | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/export` | read | venue | partial | inventory:read | - | exportController.exportPurchaseOrders |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/adjust-stock` | action | venue | partial | inventory:adjust | AdjustStockSchema | rawMaterialController.adjustStock |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/batches` | read | venue | partial | inventory:read | RawMaterialIdParamsSchema | stockBatchController.getBatchesForRawMaterial |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/movements/export` | read | venue | partial | inventory:read | - | exportController.exportStockMovements |
| GET | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/presentations` | read | venue | partial | inventory:read | RawMaterialIdParamsSchema | rawMaterialPresentationController.getPresentations |
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/presentations` | mutation | venue | partial | inventory:update | SetRawMaterialPresentationsSchema | rawMaterialPresentationController.setPresentations |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/export` | read | venue | partial | inventory:read | - | exportController.exportRawMaterials |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/reports/stock-coverage` | read | venue | partial | inventory:read | GetStockCoverageReportSchema | reportController.getStockCoverageReport |
...
| GET | `/api/v1/dashboard/venues/:venueId/inventory/suppliers/export` | read | venue | partial | inventory:read | - | exportController.exportSuppliers |
...
| GET | `/api/v1/dashboard/venues/:venueId/loyalty/card-design` | read | venue | missing | loyalty:read | LoyaltyVenueParamsSchema | loyaltyController.getCardDesignHandler |
| PUT | `/api/v1/dashboard/venues/:venueId/loyalty/card-design` | mutation | venue | missing | loyalty:update | CardDesignUpdateSchema | loyaltyController.updateCardDesignHandler |
| POST | `/api/v1/dashboard/venues/:venueId/loyalty/card-design/image` | action | venue | missing | loyalty:update | - | loyaltyController.uploadCardImageHandler |
| GET | `/api/v1/dashboard/venues/:venueId/loyalty/card-design/strip.png` | read | venue | missing | loyalty:read | - | loyaltyController.cardStripPreviewHandler |
...
| GET | `/api/v1/dashboard/venues/:venueId/loyalty/customers/:customerId/stamp-card` | read | venue | partial | loyalty:read | - | loyaltyController.getStampCardHandler |
...
| POST | `/api/v1/dashboard/venues/:venueId/loyalty/stamp-rewards/:rewardId/redeem` | action | venue | missing | loyalty:redeem | RedeemStampRewardSchema | loyaltyController.redeemStampRewardHandler |
| GET | `/api/v1/dashboard/venues/:venueId/master-catalog/access` | read | venue | missing | - | - | controller.getVenueAccess |
| GET | `/api/v1/dashboard/venues/:venueId/master-catalog/changes` | read | venue | missing | - | - | controller.listVenueChanges |
| POST | `/api/v1/dashboard/venues/:venueId/master-catalog/override-requests/:requestBatchId/confirm` | action | venue | missing | - | - | controller.confirmVenueOverride |
| POST | `/api/v1/dashboard/venues/:venueId/master-catalog/override-requests/preview` | action | venue | missing | - | - | controller.previewVenueOverride |
| GET | `/api/v1/dashboard/venues/:venueId/master-catalog/products/:productId/provenance` | read | venue | partial | - | - | controller.getVenueProvenance |
...
| GET | `/api/v1/dashboard/venues/:venueId/orders` | read | venue | partial | orders:read | OrdersListQuerySchema | // Apunta al nuevo controlador |
...
| GET | `/api/v1/dashboard/venues/:venueId/orders/filter-options` | read | venue | partial | orders:read | - | orderController.getOrdersFilterOptions |
| GET | `/api/v1/dashboard/venues/:venueId/orders/summary` | read | venue | partial | orders:read | OrdersSummaryQuerySchema | orderController.getOrdersSummary |
...
| GET | `/api/v1/dashboard/venues/:venueId/payments` | read | venue | partial | payments:read | PaymentsListQuerySchema | nunca rechaza paymentController.getPaymentsData |
| DELETE | `/api/v1/dashboard/venues/:venueId/payments/:paymentId` | dangerousMutation | venue | partial | payments:delete | - | paymentController.deletePayment |
...
| PUT | `/api/v1/dashboard/venues/:venueId/payments/:paymentId` | mutation | venue | partial | payments:update | - | paymentController.updatePayment |
...
| GET | `/api/v1/dashboard/venues/:venueId/payments/filter-options` | read | venue | partial | payments:read | - | paymentController.getPaymentsFilterOptions |
...
| GET | `/api/v1/dashboard/venues/:venueId/payments/summary` | read | venue | partial | payments:read | PaymentsSummaryQuerySchema | paymentController.getPaymentsSummary |
...
| GET | `/api/v1/dashboard/venues/:venueId/privacy-notice` | read | venue | missing | marketing:read | GetPrivacyNoticeSchema | privacyNoticeController.getPrivacyNotice |
| PUT | `/api/v1/dashboard/venues/:venueId/privacy-notice` | mutation | venue | missing | marketing:manage | UpsertPrivacyNoticeSchema | privacyNoticeController.upsertPrivacyNotice |
...
| GET | `/api/v1/dashboard/venues/:venueId/promotions` | read | venue | missing | discounts:read | z.object | promotionDashboardController.getPromotions |
| POST | `/api/v1/dashboard/venues/:venueId/promotions` | action | venue | missing | discounts:create | z.object | promotionDashboardController.createPromotion |
| DELETE | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId` | dangerousMutation | venue | missing | discounts:delete | z.object | promotionDashboardController.deletePromotion |
| GET | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId` | read | venue | missing | discounts:read | z.object | promotionDashboardController.getPromotionById |
| PUT | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId` | mutation | venue | missing | discounts:update | z.object | promotionDashboardController.updatePromotion |
| POST | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId/archive` | dangerousMutation | venue | missing | discounts:update | z.object | promotionDashboardController.archivePromotion |
| POST | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId/publish` | action | venue | missing | discounts:update | z.object | promotionDashboardController.publishPromotion |
| POST | `/api/v1/dashboard/venues/:venueId/promotions/:promotionId/unarchive` | dangerousMutation | venue | missing | discounts:update | z.object | promotionDashboardController.unarchivePromotion |
...
| GET | `/api/v1/dashboard/venues/:venueId/refunds/:refundId/credit-note` | read | venue | missing | cfdi:view | - | getRefundCreditNoteController |
| POST | `/api/v1/dashboard/venues/:venueId/refunds/:refundId/credit-note` | dangerousMutation | venue | missing | cfdi:issue | - | emitRefundCreditNoteController |
...
| POST | `/api/v1/dashboard/venues/:venueId/reservations/:id/check-in/undo` | action | venue | partial | reservations:update | - | controller.undoReservationCheckIn |
...
| DELETE | `/api/v1/dashboard/venues/:venueId/reviews/:reviewId` | dangerousMutation | venue | covered | reviews:delete | - | reviewController.deleteReview |
...
| PUT | `/api/v1/dashboard/venues/:venueId/shifts/:shiftId` | mutation | venue | partial | shifts:update | UpdateShiftSchema | shiftController.updateShift |
| GET | `/api/v1/dashboard/venues/:venueId/shifts/summary` | read | venue | partial | shifts:read | - | shiftController.getShiftsSummary |
| DELETE | `/api/v1/dashboard/venues/:venueId/staff-documents/:documentId` | dangerousMutation | venue | missing | staff-documents:write | StaffDocumentIdParamsSchema | staffDocumentController.removeDocument |
| GET | `/api/v1/dashboard/venues/:venueId/staff-documents/:documentId/url` | read | venue | missing | staff-documents:read | StaffDocumentIdParamsSchema | staffDocumentController.getDocumentUrl |
...
| POST | `/api/v1/dashboard/venues/:venueId/stores-analysis/sales-export-audit` | action | venue | partial | - | - | (inline handler) |
| GET | `/api/v1/dashboard/venues/:venueId/stores-analysis/sales-export-rows` | read | venue | partial | - | - | (inline handler) |
...
| GET | `/api/v1/dashboard/venues/:venueId/team/:staffId/documents` | read | venue | partial | staff-documents:read | StaffDocumentsParamsSchema | staffDocumentController.listDocuments |
| POST | `/api/v1/dashboard/venues/:venueId/team/:staffId/documents` | action | venue | partial | staff-documents:write | AddStaffDocumentSchema | staffDocumentController.addDocument |
| PUT | `/api/v1/dashboard/venues/:venueId/team/:staffVenueId/overtime-approval` | mutation | venue | partial | attendance:manage | ApproveOvertimeSchema | attendanceController.approveOvertime |
| GET | `/api/v1/dashboard/venues/:venueId/team/:staffVenueId/work-schedule` | read | venue | partial | attendance:read | WorkScheduleParamsSchema | attendanceController.getWorkSchedule |
| PUT | `/api/v1/dashboard/venues/:venueId/team/:staffVenueId/work-schedule` | mutation | venue | partial | attendance:manage | ReplaceWorkScheduleSchema | attendanceController.replaceWorkSchedule |
...
| GET | `/api/v1/dashboard/venues/:venueId/team/:teamMemberId/deactivation-impact` | read | venue | partial | teams:delete | TeamMemberParamsSchema | teamController.getDeactivationImpact |
| DELETE | `/api/v1/dashboard/venues/:venueId/team/:teamMemberId/hard-delete` | dangerousMutation | venue | partial | - | TeamMemberParamsSchema | teamController.hardDeleteTeamMember |
...
| GET | `/api/v1/dashboard/venues/:venueId/tender-types` | read | venue | missing | tender-types:read | z.object | tenderTypeController.listTenderTypes |
| POST | `/api/v1/dashboard/venues/:venueId/tender-types` | action | venue | missing | tender-types:manage | z.object | tenderTypeController.createTenderType |
| PATCH | `/api/v1/dashboard/venues/:venueId/tender-types/:tenderTypeId` | mutation | venue | missing | tender-types:manage | z.object | tenderTypeController.updateTenderType |
| GET | `/api/v1/dashboard/venues/:venueId/tender-types/commissions` | read | venue | partial | tender-types:read | z.object | tenderTypeController.getTenderCommissions |
| POST | `/api/v1/dashboard/venues/:venueId/terminals/:terminalId/display-mode-request` | action | venue | missing | tpv:update | createDisplayModeRequestSchema | displayModeRequestController.createRequest |
| DELETE | `/api/v1/dashboard/venues/:venueId/terminals/:terminalId/display-mode-request/:requestId` | dangerousMutation | venue | missing | tpv:update | cancelDisplayModeRequestSchema | displayModeRequestController.cancelRequest |
| GET | `/api/v1/dashboard/venues/:venueId/time-entries` | read | venue | missing | attendance:read | VenueTimeEntriesQuerySchema | attendanceController.getTimeEntries |
| GET | `/api/v1/dashboard/venues/:venueId/time-entries/active` | read | venue | missing | attendance:read | VenueIdOnlySchema | attendanceController.getActiveStaff |
| GET | `/api/v1/dashboard/venues/:venueId/time-entries/summary/:staffId` | read | venue | partial | attendance:read | StaffTimeSummarySchema | attendanceController.getStaffTimeSummary |
...
| POST | `/api/v1/dashboard/venues/:venueId/tpv/:terminalId/command` | action | venue | missing | tpv:command | - | tpvController.sendTpvCommand |
...
| DELETE | `/api/v1/dashboard/venues/:venueId/tpvs/:deviceId/sessions` | dangerousMutation | venue | missing | tpv:update | - | tpvController.revokeDeviceSessions |
...
| GET | `/api/v1/dashboard/venues/:venueId/upsell-performance` | read | venue | missing | upsells:read | - | upsellDashboardController.getUpsellPerformance |
| PUT | `/api/v1/dashboard/venues/:venueId/upsell-products` | mutation | venue | partial | upsells:update | setProductUpsellEnabledSchema | upsellDashboardController.updateProductUpsellEnabled |
| GET | `/api/v1/dashboard/venues/:venueId/upsell-rules` | read | venue | missing | upsells:read | - | upsellDashboardController.listUpsellRules |
| POST | `/api/v1/dashboard/venues/:venueId/upsell-rules` | action | venue | missing | upsells:create | createUpsellRuleSchema | upsellDashboardController.createUpsellRule |
| DELETE | `/api/v1/dashboard/venues/:venueId/upsell-rules/:ruleId` | dangerousMutation | venue | missing | upsells:delete | - | upsellDashboardController.deleteUpsellRule |
| PATCH | `/api/v1/dashboard/venues/:venueId/upsell-rules/:ruleId` | mutation | venue | missing | upsells:update | updateUpsellRuleSchema | upsellDashboardController.updateUpsellRule |
| POST | `/api/v1/dashboard/venues/:venueId/upsell-rules/:ruleId/approve` | dangerousMutation | venue | missing | upsells:update | - | upsellDashboardController.approveUpsellRule |
| POST | `/api/v1/dashboard/venues/:venueId/upsell-rules/:ruleId/dismiss` | action | venue | missing | upsells:update | - | upsellDashboardController.dismissUpsellRule |
| POST | `/api/v1/dashboard/venues/:venueId/upsell-rules/generate` | action | venue | missing | upsells:create | - | upsellDashboardController.generateUpsellRulesWithAi |
| GET | `/api/v1/dashboard/venues/:venueId/upsell-surfaces` | read | venue | missing | upsells:read | - | upsellDashboardController.getSurfaces |
| PUT | `/api/v1/dashboard/venues/:venueId/upsell-surfaces` | mutation | venue | missing | upsells:update | setUpsellSurfacesSchema | upsellDashboardController.updateSurfaces |
| GET | `/api/v1/dashboard/venues/:venueId/work-shifts/assignments` | read | venue | partial | attendance:read | WorkShiftAssignmentsQuerySchema | attendanceController.getWorkShiftAssignments |
| PUT | `/api/v1/dashboard/venues/:venueId/work-shifts/assignments` | mutation | venue | partial | attendance:manage | ReplaceWorkShiftAssignmentsSchema | attendanceController.replaceWorkShiftAssignments |
| POST | `/api/v1/dashboard/venues/:venueId/work-shifts/assignments/publish` | action | venue | partial | attendance:manage | PublishWorkShiftAssignmentsSchema | attendanceController.publishWorkShiftAssignments |
| GET | `/api/v1/dashboard/venues/:venueId/work-shifts/templates` | read | venue | partial | attendance:read | WorkShiftTemplatesQuerySchema | attendanceController.listWorkShiftTemplates |
| POST | `/api/v1/dashboard/venues/:venueId/work-shifts/templates` | action | venue | partial | attendance:manage | CreateWorkShiftTemplateSchema | attendanceController.createWorkShiftTemplate |
| PUT | `/api/v1/dashboard/venues/:venueId/work-shifts/templates/:templateId` | mutation | venue | partial | attendance:manage | UpdateWorkShiftTemplateSchema | attendanceController.updateWorkShiftTemplate |
...
| GET | `/api/v1/delivery-channels/venues/:venueId/channels/uber/connect-url` | read | venue | missing | delivery-channels:manage | - | ctrl.getUberConnectUrl |
...
| GET | `/api/v1/mobile/announcements/:id` | read | unknown | missing | - | - | announcementReadController.getDetail |
| POST | `/api/v1/mobile/announcements/:id/cta` | action | unknown | missing | - | - | announcementReadController.cta |
| POST | `/api/v1/mobile/announcements/:id/dismiss` | action | unknown | missing | - | - | announcementReadController.dismiss |
| POST | `/api/v1/mobile/announcements/:id/open` | action | unknown | missing | - | - | announcementReadController.open |
| GET | `/api/v1/mobile/announcements/home` | read | unknown | missing | - | - | announcementReadController.home |
...
| POST | `/api/v1/mobile/devices/partition` | action | unknown | missing | - | - | areaTicketMobileController.assignDevicePartition |
...
| POST | `/api/v1/mobile/orders/:id/fulfill` | action | unknown | partial | orders:update | - | areaTicketMobileController.fulfillOrderArea |
| POST | `/api/v1/mobile/push/test` | action | unknown | missing | - | - | pushMobileController.sendTestPush |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts` | action | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.createCheckout |
| GET | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId` | read | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.getCheckout |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/cancel` | dangerousMutation | venue | missing | area-tickets:cancel | - | areaTicketV7MobileController.cancelCheckout |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/heartbeat` | action | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.heartbeat |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/materialize-order` | action | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.materialize |
| GET | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/payment-attempts/:attemptId` | read | venue | missing | area-tickets:checkout, payments:read | - | areaTicketV7MobileController.getPaymentAttempt |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/prepare-payment` | action | venue | missing | area-tickets:checkout, payments:create | - | areaTicketV7MobileController.preparePayment |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/tickets` | action | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.addTicket |
| DELETE | `/api/v1/mobile/venues/:venueId/area-ticket-checkouts/:sessionId/tickets/:ticketId` | dangerousMutation | venue | missing | area-tickets:checkout | - | areaTicketV7MobileController.removeTicket |
| GET | `/api/v1/mobile/venues/:venueId/area-ticket-fulfillment/pending` | read | venue | missing | area-tickets:deliver | - | areaTicketV7MobileController.pendingFulfillment |
| POST | `/api/v1/mobile/venues/:venueId/area-ticket-fulfillment/resolve` | action | venue | missing | area-tickets:deliver | - | areaTicketV7MobileController.resolveFulfillment |
| GET | `/api/v1/mobile/venues/:venueId/area-ticket-settings` | read | venue | missing | orders:read | - | areaTicketV7MobileController.getSettings |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets` | action | venue | missing | - | - | (inline handler) |
| GET | `/api/v1/mobile/venues/:venueId/area-tickets/:code` | read | venue | missing | orders:read | - | areaTicketMobileController.resolveAreaTicket |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:code/claim` | action | venue | missing | orders:update | - | areaTicketMobileController.claimAreaTicket |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:code/items` | action | venue | missing | orders:update | - | areaTicketMobileController.addAreaTicketItems |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:ticketId/external-settlement/confirm` | action | public | partial | area-tickets:confirm-external | confirmExternalSettlementSchema | areaTicketExternalMobileController.confirm |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:ticketId/external-settlement/handoff` | action | public | partial | area-tickets:issue | handoffSchema | areaTicketExternalMobileController.handoff |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:ticketId/external-settlement/not-charged` | action | public | partial | area-tickets:confirm-external | notChargedSchema | areaTicketExternalMobileController.notCharged |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:ticketId/fulfill` | action | venue | missing | area-tickets:deliver | - | areaTicketV7MobileController.fulfill |
| POST | `/api/v1/mobile/venues/:venueId/area-tickets/:ticketId/print-attempts` | action | venue | missing | area-tickets:issue | - | areaTicketV7MobileController.recordPrintAttempt |
| GET | `/api/v1/mobile/venues/:venueId/area-tickets/pending-confirmation` | read | venue | missing | area-tickets:issue | - | areaTicketExternalMobileController.listPendingConfirmation |
| POST | `/api/v1/mobile/venues/:venueId/auth/switch-user` | action | venue | missing | - | switchUserSchema | switchUserMobileController.switchUser |
...
| GET | `/api/v1/mobile/venues/:venueId/coupons` | read | venue | missing | coupons:read | - | couponMobileController.listCoupons |
| POST | `/api/v1/mobile/venues/:venueId/coupons` | action | venue | missing | coupons:create | - | couponMobileController.createCoupon |
| DELETE | `/api/v1/mobile/venues/:venueId/coupons/:couponId` | dangerousMutation | venue | missing | coupons:delete | - | couponMobileController.deleteCoupon |
| PUT | `/api/v1/mobile/venues/:venueId/coupons/:couponId` | mutation | venue | missing | coupons:update | - | couponMobileController.updateCoupon |
| POST | `/api/v1/mobile/venues/:venueId/coupons/validate` | action | venue | missing | coupons:redeem | - | couponMobileController.validateCoupon |
| POST | `/api/v1/mobile/venues/:venueId/credit-balances/:balanceId/redeem` | action | venue | missing | creditPacks:redeem | - | creditPackMobileController.redeemCredit |
| GET | `/api/v1/mobile/venues/:venueId/credit-packs` | read | venue | partial | creditPacks:read | - | creditPackMobileController.listPacks |
| POST | `/api/v1/mobile/venues/:venueId/credit-packs/:packId/sell` | action | venue | partial | creditPacks:sell | - | creditPackMobileController.sellPack |
...
| GET | `/api/v1/mobile/venues/:venueId/delivery/channels` | read | venue | missing | delivery-channels:snooze | - | deliveryChannelMobileController.listChannels |
| DELETE | `/api/v1/mobile/venues/:venueId/delivery/channels/:linkId/snooze` | dangerousMutation | venue | missing | delivery-channels:snooze | - | deliveryChannelMobileController.resumeChannel |
| POST | `/api/v1/mobile/venues/:venueId/delivery/channels/:linkId/snooze` | action | venue | missing | delivery-channels:snooze | - | deliveryChannelMobileController.snoozeChannel |
| PUT | `/api/v1/mobile/venues/:venueId/device-capabilities` | mutation | venue | missing | - | reportDeviceCapabilitiesSchema | deviceCapabilitiesMobileController.reportDeviceCapabilities |
| GET | `/api/v1/mobile/venues/:venueId/discounts` | read | venue | missing | discounts:read | - | discountMobileController.listDiscounts |
| POST | `/api/v1/mobile/venues/:venueId/discounts` | action | venue | missing | discounts:create | - | discountMobileController.createDiscount |
| DELETE | `/api/v1/mobile/venues/:venueId/discounts/:discountId` | dangerousMutation | venue | missing | discounts:delete | - | discountMobileController.deleteDiscount |
| PUT | `/api/v1/mobile/venues/:venueId/discounts/:discountId` | mutation | venue | missing | discounts:update | - | discountMobileController.updateDiscount |
| GET | `/api/v1/mobile/venues/:venueId/display-mode-request` | read | venue | missing | - | - | tpvSettingsMobileController.getDisplayModeRequest |
...
| POST | `/api/v1/mobile/venues/:venueId/estimates` | action | venue | missing | estimates:create | - | estimateMobileController.createEstimate |
...
| POST | `/api/v1/mobile/venues/:venueId/estimates/:estimateId/convert` | action | venue | missing | estimates:create | - | estimateMobileController.convertToOrder |
| PUT | `/api/v1/mobile/venues/:venueId/estimates/:estimateId/status` | mutation | venue | missing | estimates:create | - | estimateMobileController.updateStatus |
...
| GET | `/api/v1/mobile/venues/:venueId/fulfillment/pending` | read | venue | missing | orders:read | - | areaTicketMobileController.listPendingFulfillment |
...
| POST | `/api/v1/mobile/venues/:venueId/kds/orders` | action | venue | partial | orders:update | - | kdsMobileController.createKdsOrder |
| POST | `/api/v1/mobile/venues/:venueId/kds/orders/:id/bump` | action | venue | partial | orders:update | - | kdsMobileController.bumpKdsOrder |
| POST | `/api/v1/mobile/venues/:venueId/kds/orders/:id/claim-print` | action | venue | partial | orders:update | - | kdsMobileController.claimKdsPrint |
| POST | `/api/v1/mobile/venues/:venueId/kds/orders/:id/confirm-print` | action | venue | partial | orders:update | - | kdsMobileController.confirmKdsPrinted |
| POST | `/api/v1/mobile/venues/:venueId/kds/orders/:id/release-print` | action | venue | partial | orders:update | - | kdsMobileController.releaseKdsPrint |
| PUT | `/api/v1/mobile/venues/:venueId/kds/orders/:id/status` | mutation | venue | partial | orders:update | - | kdsMobileController.updateKdsOrderStatus |
| POST | `/api/v1/mobile/venues/:venueId/kiosk/check-in` | action | venue | missing | reservations:update | - | kioskCheckInController.checkInByCode |
| POST | `/api/v1/mobile/venues/:venueId/kiosk/pack-checkout` | action | venue | missing | - | - | kioskCheckInController.kioskPackCheckout |
| GET | `/api/v1/mobile/venues/:venueId/kiosk/packs` | read | venue | missing | - | - | kioskCheckInController.kioskPacks |
...
| GET | `/api/v1/mobile/venues/:venueId/my-class-now` | read | venue | missing | class-sessions:read-assigned | - | coachClassController.myClassNow |
...
| DELETE | `/api/v1/mobile/venues/:venueId/orders/:orderId` | dangerousMutation | venue | partial | orders:cancel-unpaid | - | orderMobileController.cancelOrder |
...
| POST | `/api/v1/mobile/venues/:venueId/orders/:orderId/delivery/accept` | action | venue | partial | orders:update | - | deliveryOrderMobileController.acceptOrder |
| POST | `/api/v1/mobile/venues/:venueId/orders/:orderId/delivery/deny` | action | venue | partial | orders:update | - | deliveryOrderMobileController.denyOrder |
...
| POST | `/api/v1/mobile/venues/:venueId/orders/:orderId/merge` | action | venue | partial | orders:merge | - | orderMobileController.mergeOrders |
| POST | `/api/v1/mobile/venues/:venueId/orders/:orderId/move` | action | venue | partial | tables:update | - | tableMobileController.moveOrder |
...
| POST | `/api/v1/mobile/venues/:venueId/permission-overrides` | action | venue | partial | - | createPermissionOverrideSchema | permissionOverrideMobileController.createOverride |
...
| POST | `/api/v1/mobile/venues/:venueId/products` | action | venue | partial | tpv-products:write | - | productMobileController.createProduct |
...
| GET | `/api/v1/mobile/venues/:venueId/promotions` | read | venue | missing | - | - | promotionMobileController.getPromotions |
...
| GET | `/api/v1/mobile/venues/:venueId/scale-settings` | read | venue | missing | scale:use | - | areaTicketV7MobileController.getScaleSettings |
| POST | `/api/v1/mobile/venues/:venueId/scans/resolve` | action | venue | missing | orders:read | - | areaTicketV7MobileController.resolveScan |
...
| POST | `/api/v1/mobile/venues/:venueId/sync/intents` | action | venue | missing | - | - | syncMobileController.syncIntents |
| GET | `/api/v1/mobile/venues/:venueId/tables` | read | venue | missing | tables:read | - | tableMobileController.getTables |
| POST | `/api/v1/mobile/venues/:venueId/tables/:tableId/clear` | action | venue | missing | tables:update | - | tableMobileController.clearTable |
| POST | `/api/v1/mobile/venues/:venueId/tables/:tableId/open` | action | venue | missing | tables:update | - | tableMobileController.openTable |
| GET | `/api/v1/mobile/venues/:venueId/tender-types` | read | venue | missing | payments:read | - | tenderTypeMobileController.listTenderTypesForPos |
...
| POST | `/api/v1/mobile/venues/:venueId/terminal-payment/:requestId/release` | action | venue | missing | tpv:update | - | terminalPaymentMobileController.releaseTerminalPayment |
...
| PATCH | `/api/v1/mobile/venues/:venueId/terminals/:terminalId/display-mode` | mutation | venue | missing | - | updateDisplayModeSchema | tpvSettingsMobileController.updateDisplayMode |
...
| POST | `/api/v1/mobile/venues/:venueId/terminals/:terminalId/refund-request` | dangerousMutation | venue | missing | payments:refund | - | terminalPaymentMobileController.requestRefundOnTerminal |
| GET | `/api/v1/mobile/venues/:venueId/terminals/online` | read | venue | missing | payments:create | - | terminalPaymentMobileController.getOnlineTerminals |
...
| POST | `/api/v1/mobile/venues/:venueId/upsell-impressions` | action | venue | missing | - | recordUpsellImpressionSchema | upsellMobileController.recordUpsellImpression |
| PATCH | `/api/v1/mobile/venues/:venueId/upsell-impressions/:impressionId` | mutation | venue | missing | - | convertUpsellImpressionSchema | upsellMobileController.convertUpsellImpression |
| GET | `/api/v1/mobile/venues/:venueId/upsell-rules` | read | venue | missing | upsells:read | - | upsellMobileController.listUpsellRules |
...
| POST | `/api/v1/public/contact` | public | public | blocked | - | contactSchema | submitContact |
| GET | `/api/v1/public/customers/birthdate` | public | public | blocked | - | - | customerEmailController.getBirthdateCapturePage |
| POST | `/api/v1/public/customers/birthdate` | public | public | blocked | - | - | customerEmailController.postBirthdateCapture |
| GET | `/api/v1/public/customers/unsubscribe` | public | public | blocked | - | - | customerEmailController.getCustomerUnsubscribePage |
| POST | `/api/v1/public/customers/unsubscribe` | public | public | blocked | - | - | customerEmailController.postCustomerUnsubscribe |
| POST | `/api/v1/public/labs/submit` | public | public | blocked | - | - | submitLabsBrief |
| GET | `/api/v1/public/onboarding/continuar/:token` | public | public | blocked | - | - | continuarOnboarding |
| GET | `/api/v1/public/passkit/v1/devices/:deviceLibraryIdentifier/registrations/:passTypeIdentifier` | public | public | blocked | - | - | passkitController.listUpdatedSerialsHandler |
| DELETE | `/api/v1/public/passkit/v1/devices/:deviceLibraryIdentifier/registrations/:passTypeIdentifier/:serialNumber` | public | public | blocked | - | - | passkitController.unregisterDeviceHandler |
| POST | `/api/v1/public/passkit/v1/devices/:deviceLibraryIdentifier/registrations/:passTypeIdentifier/:serialNumber` | public | public | blocked | - | - | passkitController.registerDeviceHandler |
| POST | `/api/v1/public/passkit/v1/log` | public | public | blocked | - | - | passkitController.passkitLogHandler |
| GET | `/api/v1/public/passkit/v1/passes/:passTypeIdentifier/:serialNumber` | public | public | blocked | - | - | passkitController.downloadUpdatedPassHandler |
...
| GET | `/api/v1/public/venues/:venueId/privacy-notice` | public | public | blocked | - | - | getPublicPrivacyNotice |
...
| POST | `/api/v1/public/venues/:venueSlug/customer/checkin/:challengeId` | public | public | blocked | - | - | kioskCheckInController.consumeChallenge |
...
| GET | `/api/v1/public/venues/:venueSlug/stamp-card` | public | public | blocked | - | - | walletPassController.getStampCardInfo |
| GET | `/api/v1/public/venues/:venueSlug/wallet/apple/:customerId` | public | public | blocked | - | - | walletPassController.downloadApplePass |
| GET | `/api/v1/public/venues/:venueSlug/wallet/google/:customerId` | public | public | blocked | - | - | walletPassController.downloadGooglePass |
| GET | `/api/v1/public/wallet/stamps/:serialNumber/:revision.png` | public | public | blocked | - | - | walletStampsController.getStampStrip |
...
| GET | `/api/v1/superadmin/angelpay-accounts/:id/pin` | adminOnly | superadmin | blocked | - | - | angelpayController.getAngelPayUserAccountPinController |
...
| GET | `/api/v1/superadmin/announcements` | adminOnly | superadmin | blocked | - | - | controller.list |
| POST | `/api/v1/superadmin/announcements` | adminOnly | superadmin | blocked | - | - | controller.create |
| PUT | `/api/v1/superadmin/announcements/:id` | adminOnly | superadmin | blocked | - | - | controller.update |
| POST | `/api/v1/superadmin/announcements/:id/archive` | adminOnly | superadmin | blocked | - | - | controller.archive |
| GET | `/api/v1/superadmin/announcements/:id/metrics` | adminOnly | superadmin | blocked | - | - | controller.metrics |
| POST | `/api/v1/superadmin/announcements/:id/publish` | adminOnly | superadmin | blocked | - | - | controller.publish |
| GET | `/api/v1/superadmin/announcements/capabilities` | adminOnly | superadmin | blocked | - | - | controller.capabilities |
| POST | `/api/v1/superadmin/announcements/images` | adminOnly | superadmin | blocked | - | - | controller.uploadImage |
| POST | `/api/v1/superadmin/announcements/preview-audience` | adminOnly | superadmin | blocked | - | - | controller.previewAudience |
...
| POST | `/api/v1/superadmin/billing/tax-profiles/:id/validate` | adminOnly | superadmin | blocked | platform-billing:configure | - | controller.validateTaxProfile |
...
| GET | `/api/v1/superadmin/master-catalog/organizations` | adminOnly | superadmin | blocked | - | - | controller.listOrganizations |
| GET | `/api/v1/superadmin/master-catalog/organizations/:organizationId` | adminOnly | superadmin | blocked | - | - | controller.getOrganization |
| PUT | `/api/v1/superadmin/master-catalog/organizations/:organizationId/config` | adminOnly | superadmin | blocked | - | - | controller.updateConfig |
| PUT | `/api/v1/superadmin/master-catalog/organizations/:organizationId/entitlement` | adminOnly | superadmin | blocked | - | - | controller.updateEntitlement |
| PUT | `/api/v1/superadmin/master-catalog/organizations/:organizationId/module` | adminOnly | superadmin | blocked | - | - | controller.updateModule |
| PUT | `/api/v1/superadmin/master-catalog/organizations/:organizationId/venues/:venueId/governance` | adminOnly | superadmin | blocked | - | - | controller.updateGovernance |
...
| GET | `/api/v1/superadmin/system/config-check` | adminOnly | superadmin | blocked | - | - | getConfigCheck |
...
| POST | `/api/v1/superadmin/terminals/:terminalId/migrate-discard` | adminOnly | superadmin | blocked | - | migrateDiscardSchema | migrationController.discard |
...
| POST | `/api/v1/superadmin/terminals/payment-requests/:requestId/release` | adminOnly | superadmin | blocked | - | z.object | terminalController.releaseTerminalPaymentRequest |
...
| POST | `/api/v1/tpv/kiosk/challenge` | action | unknown | missing | - | - | kioskCheckInController.createChallenge |
| GET | `/api/v1/tpv/kiosk/challenge/:challengeId` | read | unknown | missing | - | - | kioskCheckInController.getChallenge |
| POST | `/api/v1/tpv/kiosk/check-in-by-code` | action | unknown | missing | - | - | kioskCheckInController.checkInByCode |
...
| GET | `/api/v1/tpv/venues/:venueId/categories` | read | venue | missing | menu:read | - | menuTpvController.getCategories |
...
| POST | `/api/v1/tpv/venues/:venueId/floor-elements` | action | venue | missing | tpv-floor-elements:write | - | floorElementController.createFloorElement |
| DELETE | `/api/v1/tpv/venues/:venueId/floor-elements/:elementId` | dangerousMutation | venue | missing | tpv-floor-elements:delete | - | floorElementController.deleteFloorElement |
| PUT | `/api/v1/tpv/venues/:venueId/floor-elements/:elementId` | mutation | venue | missing | tpv-floor-elements:write | - | floorElementController.updateFloorElement |
...
| GET | `/api/v1/tpv/venues/:venueId/menus` | read | venue | partial | menu:read | - | menuTpvController.getMenus |
...
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/cancel` | dangerousMutation | venue | partial | orders:cancel-unpaid | - | orderTableController.cancelOrder |
...
| PATCH | `/api/v1/tpv/venues/:venueId/orders/:orderId/items` | mutation | venue | partial | orders:create | addOrderItemsSchema | orderController.addItemsToOrder |
...
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/merge` | action | venue | partial | orders:merge | - | orderTableController.mergeOrders |
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/service-charges` | action | venue | partial | orders:update | - | orderTableController.applyServiceCharge |
| DELETE | `/api/v1/tpv/venues/:venueId/orders/:orderId/service-charges/:orderServiceChargeId` | dangerousMutation | venue | partial | orders:update | - | orderTableController.removeServiceCharge |
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/split` | action | venue | partial | orders:update | - | orderTableController.splitOrder |
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/split-by-seat` | action | venue | partial | orders:update | - | orderTableController.splitOrderBySeat |
...
| GET | `/api/v1/tpv/venues/:venueId/products` | read | venue | partial | menu:read | - | menuTpvController.getProducts |
| GET | `/api/v1/tpv/venues/:venueId/products/barcode/:barcode` | read | venue | partial | menu:read | - | (inline handler) |
| POST | `/api/v1/tpv/venues/:venueId/products/quick-add` | action | venue | partial | tpv-products:write | - | createTpvQuickAddProductHandler |
| POST | `/api/v1/tpv/venues/:venueId/referrals/capture` | action | venue | missing | referral:read | CaptureReferralSchema | referralsTpvController.captureCode |
| POST | `/api/v1/tpv/venues/:venueId/referrals/force-override` | action | venue | missing | referral:override-existing-customer | ForceOverrideReferralSchema | referralsTpvController.forceOverride |
| POST | `/api/v1/tpv/venues/:venueId/referrals/validate` | action | venue | missing | referral:read | ValidateReferralCodeSchema | referralsTpvController.validate |
...
| GET | `/api/v1/tpv/venues/:venueId/service-charges` | read | venue | missing | orders:read | - | orderTableController.listServiceCharges |
...
| POST | `/api/v1/tpv/venues/:venueId/shifts/:shiftId/close` | action | venue | partial | tpv-shifts:close | - | shiftController.closeShift |
| POST | `/api/v1/tpv/venues/:venueId/shifts/open` | action | venue | partial | tpv-shifts:create | - | shiftController.openShift |
| GET | `/api/v1/tpv/venues/:venueId/staff/:staffId/time-entries` | read | venue | missing | - | - | // las propias sin permiso; las ajenas con tpv-time-entries:read timeEntryController.getMyTimeEntries |
| GET | `/api/v1/tpv/venues/:venueId/staff/assignable` | read | venue | missing | orders:update | - | timeEntryController.getAssignableStaff |
| POST | `/api/v1/tpv/venues/:venueId/sync/intents` | action | venue | missing | - | - | syncTpvController.syncIntents |
| GET | `/api/v1/tpv/venues/:venueId/tables` | read | venue | missing | - | tableParamsSchema | tableController.getTables |
| POST | `/api/v1/tpv/venues/:venueId/tables` | action | venue | missing | tpv-tables:write | - | tableController.createTable |
| DELETE | `/api/v1/tpv/venues/:venueId/tables/:tableId` | dangerousMutation | venue | missing | tpv-tables:delete | - | tableController.deleteTable |
| PUT | `/api/v1/tpv/venues/:venueId/tables/:tableId` | mutation | venue | missing | tpv-tables:write | - | tableController.updateTable |
| POST | `/api/v1/tpv/venues/:venueId/tables/:tableId/clear` | action | venue | missing | tables:update | clearTableSchema | tableController.clearTable |
| POST | `/api/v1/tpv/venues/:venueId/tables/:tableId/open` | action | venue | missing | tables:update | - | tableController.openTable |
| PUT | `/api/v1/tpv/venues/:venueId/tables/:tableId/position` | mutation | venue | missing | tpv-tables:write | - | tableController.updateTablePosition |
| POST | `/api/v1/tpv/venues/:venueId/tables/assign` | action | venue | missing | tables:update | assignTableSchema | tableController.assignTable |
...
| POST | `/api/v1/tpv/venues/:venueId/wallet/scan` | action | venue | missing | loyalty:read | - | walletScanController.scanWalletPassHandler |
...
| POST | `/api/v1/webhooks/delivery/didi` | public | public | blocked | - | - | handleDidiWebhook |
| GET | `/api/v1/webhooks/delivery/didi/health` | public | public | blocked | - | - | didiWebhookHealthCheck |
| POST | `/api/v1/webhooks/delivery/rappi/:evento` | public | public | blocked | - | - | handleRappiWebhook |
| GET | `/api/v1/webhooks/delivery/rappi/health` | public | public | blocked | - | - | rappiWebhookHealthCheck |
| POST | `/api/v1/webhooks/delivery/uber` | public | public | blocked | - | - | handleUberWebhook |
| GET | `/api/v1/webhooks/delivery/uber/health` | public | public | blocked | - | - | uberWebhookHealthCheck |
