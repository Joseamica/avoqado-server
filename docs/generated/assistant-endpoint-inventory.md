...
| GET | `/api/v1/dashboard/venues/:venueId/plan/seat-status` | read | venue | missing | billing:subscriptions:read | planParamsSchema | venueController.getVenueSeatStatus |
...
| POST | `/api/v1/tpv/feedback` | action | unknown | missing | serialized-inventory:create, serialized-inventory:sell | tpvFeedbackSchema | (inline handler) |
