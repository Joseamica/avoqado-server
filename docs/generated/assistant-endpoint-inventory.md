...
Generated: 2026-08-14T17:29:53.042Z

## Summary

- Total endpoints: 1889
- Assistant tools registered: 80
- Coverage: missing 791, partial 557, blocked 536, covered 5
- Classifications: read 602, adminOnly 457, action 436, mutation 163, dangerousMutation 152, public 79
- Scopes: venue 991, superadmin 413, unknown 195, organization 169, public 121
...
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/cancel` | dangerousMutation | venue | partial | orders:cancel | - | orderTableController.cancelOrder |
...
| POST | `/api/v1/tpv/venues/:venueId/orders/:orderId/merge` | action | venue | partial | orders:update | - | orderTableController.mergeOrders |
...
| POST | `/api/v1/tpv/venues/:venueId/products/quick-add` | action | venue | partial | menu:create | - | createTpvQuickAddProductHandler |
...
| POST | `/api/v1/tpv/venues/:venueId/tables/:tableId/open` | action | venue | missing | orders:create | - | tableController.openTable |
