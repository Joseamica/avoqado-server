...
Generated: 2026-05-16T02:18:14.346Z

## Summary

- Total endpoints: 1350
- Assistant tools registered: 80
- Coverage: missing 499, partial 462, blocked 384, covered 5
- Classifications: read 431, adminOnly 344, action 285, dangerousMutation 129, mutation 121, public 40
- Scopes: venue 707, superadmin 307, unknown 173, organization 96, public 67
...
- POST `/api/v1/dashboard/organizations/:orgId/users/:userId/reset-password` — dangerousMutation; permissions: none; controller: (inline handler)
...
- PATCH `/api/v1/dashboard/superadmin/modules/:moduleId` — adminOnly; permissions: none; controller: moduleController.updateModule
- PATCH `/api/v1/dashboard/superadmin/modules/config` — adminOnly; permissions: none; controller: moduleController.updateModuleConfig
- POST `/api/v1/dashboard/superadmin/modules/disable` — adminOnly; permissions: none; controller: moduleController.disableModuleForVenue
- POST `/api/v1/dashboard/superadmin/modules/enable` — adminOnly; permissions: none; controller: moduleController.enableModuleForVenue
- DELETE `/api/v1/dashboard/superadmin/modules/venue-override` — adminOnly; permissions: none; controller: moduleController.deleteVenueModuleOverride
- GET `/api/v1/dashboard/superadmin/modules/venues/:venueId` — adminOnly; permissions: none; controller: moduleController.getModulesForVenue
- GET `/api/v1/dashboard/superadmin/organizations` — adminOnly; permissions: none; controller: organizationController.getAllOrganizations
- POST `/api/v1/dashboard/superadmin/organizations` — adminOnly; permissions: none; controller: organizationController.createOrganization
- DELETE `/api/v1/dashboard/superadmin/organizations/:organizationId` — adminOnly; permissions: none; controller: organizationController.deleteOrganization
- GET `/api/v1/dashboard/superadmin/organizations/:organizationId` — adminOnly; permissions: none; controller: organizationController.getOrganizationById
- PATCH `/api/v1/dashboard/superadmin/organizations/:organizationId` — adminOnly; permissions: none; controller: organizationController.updateOrganization
- GET `/api/v1/dashboard/superadmin/organizations/:organizationId/modules` — adminOnly; permissions: none; controller: organizationController.getModulesForOrganization
- PATCH `/api/v1/dashboard/superadmin/organizations/:organizationId/modules/config` — adminOnly; permissions: none; controller: organizationController.updateOrganizationModuleConfig
- POST `/api/v1/dashboard/superadmin/organizations/:organizationId/modules/disable` — adminOnly; permissions: none; controller: organizationController.disableModuleForOrganization
- POST `/api/v1/dashboard/superadmin/organizations/:organizationId/modules/enable` — adminOnly; permissions: none; controller: organizationController.enableModuleForOrganization
- DELETE `/api/v1/dashboard/superadmin/organizations/:organizationId/payment-config` — adminOnly; permissions: none; controller: orgPaymentController.deletePaymentConfig
- GET `/api/v1/dashboard/superadmin/organizations/:organizationId/payment-config` — adminOnly; permissions: none; controller: orgPaymentController.getPaymentConfig
- PUT `/api/v1/dashboard/superadmin/organizations/:organizationId/payment-config` — adminOnly; permissions: none; controller: orgPaymentController.setPaymentConfig
- PUT `/api/v1/dashboard/superadmin/organizations/:organizationId/payment-config/pricing` — adminOnly; permissions: none; controller: orgPaymentController.setPricing
...
| POST | `/api/v1/dashboard/organizations/:orgId/users/:userId/reset-password` | dangerousMutation | organization | missing | - | - | (inline handler) |
...
| POST | `/api/v1/dashboard/venues/:venueId/billing-portal` | action | venue | missing | venues:manage | createBillingPortalSessionSchema | venueController.createBillingPortalSession |
...
| PUT | `/api/v1/dashboard/venues/:venueId/crypto/setup` | mutation | venue | missing | system:manage | - | cryptoConfigController.setupCrypto as any |
...
| POST | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants` | action | venue | missing | - | createEcommerceMerchantWithVenueSchema | ecommerceMerchantController.createEcommerceMerchant |
| DELETE | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id` | dangerousMutation | venue | missing | - | getEcommerceMerchantSchema | ecommerceMerchantController.deleteEcommerceMerchant |
| GET | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id` | read | venue | missing | - | getEcommerceMerchantSchema | ecommerceMerchantController.getEcommerceMerchant |
| PUT | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id` | mutation | venue | missing | - | updateEcommerceMerchantWithVenueSchema | ecommerceMerchantController.updateEcommerceMerchant |
| GET | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/keys` | read | venue | missing | - | getEcommerceMerchantSchema | ecommerceMerchantController.getAPIKeys |
| GET | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/onboarding-status` | read | venue | missing | - | getStripeOnboardingStatusSchema | stripeConnectController.getOnboardingStatus |
| PATCH | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/platform-fee` | mutation | venue | missing | system:manage | - | ecommerceMerchantController.updatePlatformFee |
| POST | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/regenerate-keys` | action | venue | missing | - | regenerateKeysWithVenueSchema | ecommerceMerchantController.regenerateAPIKeys |
| POST | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/stripe-onboard` | action | venue | missing | - | createStripeOnboardingLinkSchema | stripeConnectController.createOnboardingLink |
| PATCH | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/:id/toggle` | mutation | venue | missing | - | toggleEcommerceMerchantWithVenueSchema | ecommerceMerchantController.toggleEcommerceMerchantStatus |
| GET | `/api/v1/dashboard/venues/:venueId/ecommerce-merchants/available-providers` | read | venue | missing | - | - | ecommerceMerchantController.listAvailableProviders |
| GET | `/api/v1/dashboard/venues/:venueId/features` | read | venue | missing | venues:read | - | venueFeatureController.getVenueFeatures |
| GET | `/api/v1/dashboard/venues/:venueId/features` | read | venue | missing | features:read | - | featureController.getVenueFeatures |
| POST | `/api/v1/dashboard/venues/:venueId/features` | action | venue | missing | venues:manage | addVenueFeaturesSchema | venueFeatureController.addVenueFeatures |
| POST | `/api/v1/dashboard/venues/:venueId/features` | action | venue | missing | features:write | - | featureController.saveVenueFeatures |
| DELETE | `/api/v1/dashboard/venues/:venueId/features/:featureId` | dangerousMutation | venue | missing | venues:manage | - | venueFeatureController.removeVenueFeature |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/alerts` | action | venue | partial | inventory:read | - | alertController.createManualAlert |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/alerts/:alertId/acknowledge` | action | venue | partial | inventory:read | AcknowledgeAlertSchema | alertController.acknowledgeAlert |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/alerts/:alertId/dismiss` | action | venue | partial | inventory:read | - | alertController.dismissAlert |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/alerts/:alertId/resolve` | action | venue | partial | inventory:read | ResolveAlertSchema | alertController.resolveAlert |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/apply-suggested-price` | action | venue | partial | inventory:read | - | pricingController.applySuggestedPrice |
...
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/inventory-method` | mutation | venue | partial | inventory:read | SetProductInventoryMethodSchema | productWizardController.setProductInventoryMethod |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/pricing-policy` | action | venue | partial | inventory:read | CreatePricingPolicySchema | pricingController.createPricingPolicy |
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/pricing-policy` | mutation | venue | partial | inventory:read | UpdatePricingPolicySchema | pricingController.updatePricingPolicy |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/recipe` | action | venue | partial | inventory:read | CreateRecipeSchema | recipeController.createRecipe |
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/recipe` | mutation | venue | partial | inventory:read | UpdateRecipeSchema | recipeController.updateRecipe |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/recipe/lines` | action | venue | partial | inventory:read | AddRecipeLineSchema | recipeController.addRecipeLine |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/switch-inventory-method` | action | venue | partial | inventory:read | SetProductInventoryMethodSchema | // Requires inventoryMethod in body (QUANTITY or RECIPE) productWizardController.switchInventoryMethod |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/wizard/step2` | action | venue | partial | inventory:read | ProductWizardStep2Schema | productWizardController.configureInventoryStep2 |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/wizard/step3-recipe` | action | venue | partial | inventory:read | ProductWizardStep3RecipeSchema | productWizardController.setupRecipeStep3 |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/products/:productId/wizard/step3-simple` | action | venue | partial | inventory:read | ProductWizardStep3SimpleStockSchema | productWizardController.setupSimpleStockStep3 |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders` | action | venue | partial | inventory:read | CreatePurchaseOrderSchema | purchaseOrderController.createPurchaseOrder |
| DELETE | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId` | dangerousMutation | venue | partial | inventory:read | PurchaseOrderIdParamsSchema | purchaseOrderController.deletePurchaseOrder |
...
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId` | mutation | venue | partial | inventory:read | UpdatePurchaseOrderSchema | purchaseOrderController.updatePurchaseOrder |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/approve` | dangerousMutation | venue | partial | inventory:read | - | purchaseOrderController.approvePurchaseOrder |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/cancel` | dangerousMutation | venue | partial | inventory:read | - | purchaseOrderController.cancelPurchaseOrder |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/purchase-orders/:purchaseOrderId/receive` | action | venue | partial | inventory:read | ReceivePurchaseOrderSchema | purchaseOrderController.receivePurchaseOrder |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/adjust-stock` | action | venue | partial | inventory:read | AdjustStockSchema | rawMaterialController.adjustStock |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/raw-materials/:rawMaterialId/trigger-cost-recalculation` | action | venue | partial | inventory:read | TriggerCostRecalculationSchema | productWizardController.triggerCostRecalculation |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/recalculate-all-recipes` | action | venue | partial | inventory:read | VenueIdParamsSchema | productWizardController.recalculateAllRecipes |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/recalculate-stale-recipes` | action | venue | partial | inventory:read | VenueIdParamsSchema | productWizardController.recalculateStaleRecipes |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/suppliers` | action | venue | partial | inventory:read | CreateSupplierSchema | supplierController.createSupplier |
...
| PUT | `/api/v1/dashboard/venues/:venueId/inventory/suppliers/:supplierId` | mutation | venue | partial | inventory:read | UpdateSupplierSchema | supplierController.updateSupplier |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/suppliers/:supplierId/pricing` | action | venue | partial | inventory:read | CreateSupplierPricingSchema | supplierController.createSupplierPricing |
...
| POST | `/api/v1/dashboard/venues/:venueId/inventory/wizard/complete` | dangerousMutation | venue | partial | inventory:read | CreateProductWithInventorySchema | productWizardController.createProductWithInventory |
| POST | `/api/v1/dashboard/venues/:venueId/inventory/wizard/step1` | action | venue | partial | inventory:read | ProductWizardStep1Schema | productWizardController.createProductStep1 |
| GET | `/api/v1/dashboard/venues/:venueId/invoices` | read | venue | missing | features:read | - | venueFeatureController.getVenueInvoices |
| GET | `/api/v1/dashboard/venues/:venueId/invoices/:invoiceId/download` | read | venue | missing | features:read | - | venueFeatureController.downloadInvoice |
| POST | `/api/v1/dashboard/venues/:venueId/invoices/:invoiceId/retry` | action | venue | missing | payments:create | - | venueFeatureController.retryInvoicePayment |
...
| PUT | `/api/v1/dashboard/venues/:venueId/payment-methods/set-default` | mutation | venue | partial | venues:manage | - | venueController.setVenueDefaultPaymentMethod |
...
| GET | `/api/v1/tpv/venues/:venueId/time-entries` | read | venue | missing | shifts:manage | - | timeEntryController.getTimeEntries |
| GET | `/api/v1/tpv/venues/:venueId/time-entries/active` | read | venue | missing | shifts:manage | - | timeEntryController.getCurrentlyClockedInStaff |
