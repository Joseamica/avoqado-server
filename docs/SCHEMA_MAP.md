...
- `Aggregator` → `schema.prisma:L10185`
- `AngelPayUserAccount` → `schema.prisma:L3651`
- `AppUpdate` → `schema.prisma:L8478`
- `Area` → `schema.prisma:L2061`
- `BulkCommandOperation` → `schema.prisma:L6850`
- `CalendarSyncOutbox` → `schema.prisma:L9588`
- `CampaignDelivery` → `schema.prisma:L8629`
- `CashCloseout` → `schema.prisma:L7183`
- `CashDeposit` → `schema.prisma:L8298`
- `CashDrawerEvent` → `schema.prisma:L10031`
- `CashDrawerSession` → `schema.prisma:L10007`
- `Cfdi` → `schema.prisma:L10519`
...
- `ClassSession` → `schema.prisma:L9209`
...
- `CreditItemBalance` → `schema.prisma:L9797`
- `CreditOffer` → `schema.prisma:L7311`
- `CreditPack` → `schema.prisma:L9713`
- `CreditPackItem` → `schema.prisma:L9742`
- `CreditPackPurchase` → `schema.prisma:L9759`
- `CreditTransaction` → `schema.prisma:L9819`
- `Customer` → `schema.prisma:L4868`
- `CustomerDiscount` → `schema.prisma:L5330`
- `CustomerGroup` → `schema.prisma:L5019`
- `CustomerTaxProfile` → `schema.prisma:L10588`
...
- `EmailTemplate` → `schema.prisma:L8568`
- `Estimate` → `schema.prisma:L10092`
- `EstimateItem` → `schema.prisma:L10120`
- `ExternalBusyBlock` → `schema.prisma:L9481`
- `Feature` → `schema.prisma:L2964`
- `FeeSchedule` → `schema.prisma:L3042`
- `FeeTier` → `schema.prisma:L3053`
- `FiscalEmisor` → `schema.prisma:L10461`
- `FloorElement` → `schema.prisma:L2137`
- `GeofenceRule` → `schema.prisma:L6935`
- `GoogleCalendarChannel` → `schema.prisma:L9458`
- `GoogleCalendarConnection` → `schema.prisma:L9410`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L9511`
- `GoogleOAuthSession` → `schema.prisma:L9533`
...
- `MarketingCampaign` → `schema.prisma:L8586`
- `McpAuthCode` → `schema.prisma:L10368`
- `McpOAuthClient` → `schema.prisma:L10352`
- `McpRefreshToken` → `schema.prisma:L10386`
- `MeasurementUnit` → `schema.prisma:L10170`
- `Menu` → `schema.prisma:L1278`
- `MenuCategory` → `schema.prisma:L1220`
- `MenuCategoryAssignment` → `schema.prisma:L1313`
- `MercadoPagoWebhookEvent` → `schema.prisma:L10301`
- `MerchantAccount` → `schema.prisma:L3525`
- `MerchantFiscalConfig` → `schema.prisma:L10497`
...
- `PaymentLink` → `schema.prisma:L9865`
- `PaymentLinkAttribution` → `schema.prisma:L9973`
- `PaymentLinkItem` → `schema.prisma:L9928`
- `PaymentLinkItemModifier` → `schema.prisma:L9955`
...
- `ProductOption` → `schema.prisma:L10147`
- `ProductOptionValue` → `schema.prisma:L10158`
...
- `Reservation` → `schema.prisma:L8965`
- `ReservationGoogleEventMapping` → `schema.prisma:L9645`
- `ReservationModifier` → `schema.prisma:L9124`
- `ReservationReminderSent` → `schema.prisma:L9107`
- `ReservationSettings` → `schema.prisma:L9285`
- `ReservationWaitlistEntry` → `schema.prisma:L9253`
...
- `SlotHold` → `schema.prisma:L9164`
- `Staff` → `schema.prisma:L728`
- `StaffOnboardingState` → `schema.prisma:L10271`
...
- `TpvMessage` → `schema.prisma:L8661`
- `TpvMessageDelivery` → `schema.prisma:L8713`
- `TpvMessageResponse` → `schema.prisma:L8736`
- `TrainingModule` → `schema.prisma:L8791`
- `TrainingProgress` → `schema.prisma:L8868`
- `TrainingQuizQuestion` → `schema.prisma:L8850`
- `TrainingStep` → `schema.prisma:L8830`
