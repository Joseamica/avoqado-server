...
- `AccountingPeriodLock` → `schema.prisma:L14420`
- `AccountMapping` → `schema.prisma:L14316`
...
- `AreaTicket` → `schema.prisma:L13211`
- `AreaTicketCheckoutSession` → `schema.prisma:L13333`
- `AreaTicketExternalIncident` → `schema.prisma:L13580`
- `AreaTicketExternalSettlement` → `schema.prisma:L13545`
- `AreaTicketFulfillment` → `schema.prisma:L13409`
- `AreaTicketInventoryReservation` → `schema.prisma:L13304`
- `AreaTicketLine` → `schema.prisma:L13272`
- `AreaTicketPaymentAttempt` → `schema.prisma:L13365`
- `AreaTicketPrintAttempt` → `schema.prisma:L13388`
- `BankStatement` → `schema.prisma:L14190`
- `BankStatementLine` → `schema.prisma:L14211`
- `BillingTaxProfile` → `schema.prisma:L15000`
...
- `CashOutCommissionRate` → `schema.prisma:L14829`
- `CashOutScheduleDay` → `schema.prisma:L14852`
- `CashOutWithdrawal` → `schema.prisma:L14914`
...
- `CustomerTaxProfile` → `schema.prisma:L14162`
...
- `FiscalEmisor` → `schema.prisma:L14016`
- `FiscalLossCarryforward` → `schema.prisma:L14587`
- `FixedAsset` → `schema.prisma:L14605`
- `FixedAssetDepreciation` → `schema.prisma:L14634`
- `FloorElement` → `schema.prisma:L2673`
- `FulfillmentArea` → `schema.prisma:L13076`
...
- `JournalEntry` → `schema.prisma:L14374`
- `JournalLine` → `schema.prisma:L14402`
- `KdsOrder` → `schema.prisma:L12929`
- `KdsOrderItem` → `schema.prisma:L12946`
- `LearnedPatterns` → `schema.prisma:L7897`
- `LedgerAccount` → `schema.prisma:L14266`
...
- `McpAuthCode` → `schema.prisma:L13899`
- `McpOAuthClient` → `schema.prisma:L13883`
- `McpRefreshToken` → `schema.prisma:L13917`
- `McpToolCall` → `schema.prisma:L13938`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L13813`
- `MerchantAccount` → `schema.prisma:L4373`
- `MerchantFiscalConfig` → `schema.prisma:L14064`
...
- `OrderFulfillment` → `schema.prisma:L13131`
- `OrderFulfillmentLine` → `schema.prisma:L13162`
...
- `PayrollLine` → `schema.prisma:L14748`
- `PayrollRun` → `schema.prisma:L14717`
- `PerformanceGoal` → `schema.prisma:L10864`
- `PermissionSet` → `schema.prisma:L1250`
- `PlatformCfdi` → `schema.prisma:L15033`
- `PlatformEmisor` → `schema.prisma:L14973`
- `PlatformSettings` → `schema.prisma:L4754`
- `PosCommand` → `schema.prisma:L6948`
- `PosConnectionStatus` → `schema.prisma:L848`
- `PosSyncIntent` → `schema.prisma:L15111`
- `PricingPolicy` → `schema.prisma:L2190`
- `Printer` → `schema.prisma:L12975`
- `PrintGateway` → `schema.prisma:L13012`
- `PrintJob` → `schema.prisma:L13712`
- `PrintStation` → `schema.prisma:L13030`
...
- `PromoterBankAccount` → `schema.prisma:L14868`
- `PromoterCommissionEntry` → `schema.prisma:L14887`
...
- `SalesRetention` → `schema.prisma:L14568`
- `SaleVerification` → `schema.prisma:L3577`
- `ScaleProfile` → `schema.prisma:L13453`
...
- `StaffOnboardingState` → `schema.prisma:L13783`
...
- `VenueAreaTicketSettings` → `schema.prisma:L13190`
...
- `VenueScaleSettings` → `schema.prisma:L13441`
