...
- `AccountingPeriodLock` → `schema.prisma:L13126`
- `AccountMapping` → `schema.prisma:L13022`
...
- `AreaTicketCheckoutSession` → `schema.prisma:L12180`
- `AreaTicketFulfillment` → `schema.prisma:L12256`
- `AreaTicketInventoryReservation` → `schema.prisma:L12155`
- `AreaTicketLine` → `schema.prisma:L12123`
- `AreaTicketPaymentAttempt` → `schema.prisma:L12212`
- `AreaTicketPrintAttempt` → `schema.prisma:L12235`
- `BankStatement` → `schema.prisma:L12896`
- `BankStatementLine` → `schema.prisma:L12917`
- `BillingTaxProfile` → `schema.prisma:L13706`
...
- `CashOutCommissionRate` → `schema.prisma:L13535`
- `CashOutScheduleDay` → `schema.prisma:L13558`
- `CashOutWithdrawal` → `schema.prisma:L13620`
- `Cfdi` → `schema.prisma:L12799`
...
- `CustomerTaxProfile` → `schema.prisma:L12868`
...
- `FiscalEmisor` → `schema.prisma:L12722`
- `FiscalLossCarryforward` → `schema.prisma:L13293`
- `FixedAsset` → `schema.prisma:L13311`
- `FixedAssetDepreciation` → `schema.prisma:L13340`
...
- `JournalEntry` → `schema.prisma:L13080`
- `JournalLine` → `schema.prisma:L13108`
- `KdsOrder` → `schema.prisma:L11798`
- `KdsOrderItem` → `schema.prisma:L11815`
- `LearnedPatterns` → `schema.prisma:L7773`
- `LedgerAccount` → `schema.prisma:L12972`
...
- `McpAuthCode` → `schema.prisma:L12605`
- `McpOAuthClient` → `schema.prisma:L12589`
- `McpRefreshToken` → `schema.prisma:L12623`
- `McpToolCall` → `schema.prisma:L12644`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L12519`
- `MerchantAccount` → `schema.prisma:L4264`
- `MerchantFiscalConfig` → `schema.prisma:L12770`
...
- `PromoterBankAccount` → `schema.prisma:L13574`
- `PromoterCommissionEntry` → `schema.prisma:L13593`
...
- `SalesRetention` → `schema.prisma:L13274`
- `SaleVerification` → `schema.prisma:L3475`
- `ScaleProfile` → `schema.prisma:L12289`
...
- `StaffOnboardingState` → `schema.prisma:L12489`
...
- `VenueScaleSettings` → `schema.prisma:L12279`
