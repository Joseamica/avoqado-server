...
- `AccountingPeriodLock` → `schema.prisma:L16716`
- `AccountMapping` → `schema.prisma:L16612`
...
- `AreaTicket` → `schema.prisma:L15490`
- `AreaTicketCheckoutSession` → `schema.prisma:L15612`
- `AreaTicketExternalIncident` → `schema.prisma:L15859`
- `AreaTicketExternalSettlement` → `schema.prisma:L15824`
- `AreaTicketFulfillment` → `schema.prisma:L15688`
- `AreaTicketInventoryReservation` → `schema.prisma:L15583`
- `AreaTicketLine` → `schema.prisma:L15551`
- `AreaTicketPaymentAttempt` → `schema.prisma:L15644`
- `AreaTicketPrintAttempt` → `schema.prisma:L15667`
- `BankStatement` → `schema.prisma:L16486`
- `BankStatementLine` → `schema.prisma:L16507`
- `BillingObligationConflict` → `schema.prisma:L4764`
- `BillingTaxProfile` → `schema.prisma:L17296`
...
- `CashOutCommissionRate` → `schema.prisma:L17125`
- `CashOutScheduleDay` → `schema.prisma:L17148`
- `CashOutWithdrawal` → `schema.prisma:L17210`
...
- `CustomerTaxProfile` → `schema.prisma:L16458`
...
- `FiscalEmisor` → `schema.prisma:L16295`
- `FiscalLossCarryforward` → `schema.prisma:L16883`
- `FixedAsset` → `schema.prisma:L16901`
- `FixedAssetDepreciation` → `schema.prisma:L16930`
- `FloorElement` → `schema.prisma:L3278`
- `FulfillmentArea` → `schema.prisma:L15355`
...
- `JournalEntry` → `schema.prisma:L16670`
- `JournalLine` → `schema.prisma:L16698`
- `KdsOrder` → `schema.prisma:L15117`
- `KdsOrderItem` → `schema.prisma:L15166`
- `KioskCheckInAttempt` → `schema.prisma:L17619`
- `KioskCheckInChallenge` → `schema.prisma:L17573`
- `KioskOutreachOutbox` → `schema.prisma:L17640`
- `LaunchCampaign` → `schema.prisma:L17978`
- `LaunchCampaignRedemption` → `schema.prisma:L18095`
- `LearnedPatterns` → `schema.prisma:L9987`
- `LedgerAccount` → `schema.prisma:L16562`
...
- `McpAuthCode` → `schema.prisma:L16178`
- `McpOAuthClient` → `schema.prisma:L16162`
- `McpRefreshToken` → `schema.prisma:L16196`
- `McpToolCall` → `schema.prisma:L16217`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L16092`
- `MerchantAccount` → `schema.prisma:L5557`
- `MerchantFiscalConfig` → `schema.prisma:L16350`
...
- `OrderFulfillment` → `schema.prisma:L15410`
- `OrderFulfillmentLine` → `schema.prisma:L15441`
- `OrderItem` → `schema.prisma:L4005`
- `OrderItemModifier` → `schema.prisma:L4228`
- `OrderPromotion` → `schema.prisma:L17536`
...
- `PaymentEffect` → `schema.prisma:L17910`
...
- `PayrollLine` → `schema.prisma:L17044`
- `PayrollRun` → `schema.prisma:L17013`
- `PerformanceGoal` → `schema.prisma:L12988`
- `PermissionOverride` → `schema.prisma:L1403`
- `PermissionSet` → `schema.prisma:L1426`
- `PlatformAnnouncement` → `schema.prisma:L17700`
- `PlatformAnnouncementClick` → `schema.prisma:L17765`
- `PlatformAnnouncementDelivery` → `schema.prisma:L17802`
- `PlatformCfdi` → `schema.prisma:L17329`
- `PlatformEmisor` → `schema.prisma:L17269`
- `PlatformSettings` → `schema.prisma:L5938`
- `PosCommand` → `schema.prisma:L8917`
- `PosConnectionStatus` → `schema.prisma:L949`
- `PosSyncIntent` → `schema.prisma:L17407`
- `PricingPolicy` → `schema.prisma:L2760`
- `Printer` → `schema.prisma:L15215`
- `PrintGateway` → `schema.prisma:L15272`
- `PrintJob` → `schema.prisma:L15991`
...
- `PromoterBankAccount` → `schema.prisma:L17164`
- `PromoterCommissionEntry` → `schema.prisma:L17183`
- `PromoterLocationPing` → `schema.prisma:L3693`
- `Promotion` → `schema.prisma:L17458`
- `PromotionGroup` → `schema.prisma:L17497`
- `PromotionOption` → `schema.prisma:L17513`
...
- `ReceiptLayout` → `schema.prisma:L17944`
...
- `RefreshGrant` → `schema.prisma:L17889`
...
- `SalesRetention` → `schema.prisma:L16864`
- `SaleVerification` → `schema.prisma:L4606`
- `ScaleProfile` → `schema.prisma:L15732`
...
- `StaffOnboardingState` → `schema.prisma:L16062`
...
- `VenueAreaTicketSettings` → `schema.prisma:L15469`
...
- `VenueScaleSettings` → `schema.prisma:L15720`
