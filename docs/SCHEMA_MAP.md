...
- `AccountingPeriodLock` → `schema.prisma:L11606`
- `AccountMapping` → `schema.prisma:L11502`
- `ActivityLog` → `schema.prisma:L5136`
- `Aggregator` → `schema.prisma:L10650`
- `AngelPayUserAccount` → `schema.prisma:L3882`
- `AppUpdate` → `schema.prisma:L8936`
- `Area` → `schema.prisma:L2136`
- `BankStatement` → `schema.prisma:L11376`
- `BankStatementLine` → `schema.prisma:L11397`
- `BillingTaxProfile` → `schema.prisma:L12186`
- `BulkCommandOperation` → `schema.prisma:L7289`
- `CalendarSyncOutbox` → `schema.prisma:L10053`
- `CampaignDelivery` → `schema.prisma:L9094`
- `CashCloseout` → `schema.prisma:L7622`
- `CashDeposit` → `schema.prisma:L8738`
- `CashDrawerEvent` → `schema.prisma:L10496`
- `CashDrawerSession` → `schema.prisma:L10472`
- `CashOutCommissionRate` → `schema.prisma:L12015`
- `CashOutScheduleDay` → `schema.prisma:L12038`
- `CashOutWithdrawal` → `schema.prisma:L12100`
- `Cfdi` → `schema.prisma:L11279`
- `ChatbotTokenBudget` → `schema.prisma:L6937`
- `ChatConversation` → `schema.prisma:L6792`
- `ChatFeedback` → `schema.prisma:L6878`
- `ChatLearningEvent` → `schema.prisma:L6835`
- `ChatMessage` → `schema.prisma:L6815`
- `ChatTrainingData` → `schema.prisma:L6749`
- `CheckoutSession` → `schema.prisma:L4162`
- `ClassSession` → `schema.prisma:L9674`
- `CommissionCalculation` → `schema.prisma:L8517`
- `CommissionClawback` → `schema.prisma:L8690`
- `CommissionConfig` → `schema.prisma:L8290`
- `CommissionMilestone` → `schema.prisma:L8433`
- `CommissionOverride` → `schema.prisma:L8360`
- `CommissionPayout` → `schema.prisma:L8641`
- `CommissionSummary` → `schema.prisma:L8580`
- `CommissionTier` → `schema.prisma:L8397`
- `Consumer` → `schema.prisma:L5257`
- `ConsumerAuthAccount` → `schema.prisma:L5282`
- `CouponCode` → `schema.prisma:L5685`
- `CouponRedemption` → `schema.prisma:L5716`
- `CreditAssessmentHistory` → `schema.prisma:L7731`
- `CreditItemBalance` → `schema.prisma:L10262`
- `CreditOffer` → `schema.prisma:L7750`
- `CreditPack` → `schema.prisma:L10178`
- `CreditPackItem` → `schema.prisma:L10207`
- `CreditPackPurchase` → `schema.prisma:L10224`
- `CreditTransaction` → `schema.prisma:L10284`
- `Customer` → `schema.prisma:L5162`
- `CustomerDiscount` → `schema.prisma:L5736`
- `CustomerGroup` → `schema.prisma:L5316`
- `CustomerTaxProfile` → `schema.prisma:L11348`
- `DeliveryChannelLink` → `schema.prisma:L4448`
- `DeliveryOrderEvent` → `schema.prisma:L4483`
- `DeviceToken` → `schema.prisma:L5931`
- `DigitalReceipt` → `schema.prisma:L2976`
- `Discount` → `schema.prisma:L5585`
- `EcommerceMerchant` → `schema.prisma:L3974`
- `EmailTemplate` → `schema.prisma:L9033`
- `Employee` → `schema.prisma:L11863`
- `Estimate` → `schema.prisma:L10557`
- `EstimateItem` → `schema.prisma:L10585`
- `Expense` → `schema.prisma:L11650`
- `ExternalBusyBlock` → `schema.prisma:L9946`
- `Feature` → `schema.prisma:L3105`
- `FeeSchedule` → `schema.prisma:L3183`
- `FeeTier` → `schema.prisma:L3194`
- `FinancialAccount` → `schema.prisma:L10747`
- `FinancialConnection` → `schema.prisma:L10716`
- `FinancialProvider` → `schema.prisma:L10702`
- `FiscalEmisor` → `schema.prisma:L11202`
- `FiscalLossCarryforward` → `schema.prisma:L11773`
- `FixedAsset` → `schema.prisma:L11791`
- `FixedAssetDepreciation` → `schema.prisma:L11820`
- `FloorElement` → `schema.prisma:L2212`
- `GeofenceRule` → `schema.prisma:L7374`
- `GoogleCalendarChannel` → `schema.prisma:L9923`
- `GoogleCalendarConnection` → `schema.prisma:L9875`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L9976`
- `GoogleOAuthSession` → `schema.prisma:L9998`
- `HolidayCalendar` → `schema.prisma:L5060`
- `IdempotencyRequest` → `schema.prisma:L8165`
- `Inventory` → `schema.prisma:L1554`
- `InventoryMovement` → `schema.prisma:L1578`
- `InventoryTransfer` → `schema.prisma:L10529`
- `Invitation` → `schema.prisma:L1140`
- `Invoice` → `schema.prisma:L3206`
- `InvoiceItem` → `schema.prisma:L3232`
- `ItemCategory` → `schema.prisma:L7882`
- `JournalEntry` → `schema.prisma:L11560`
- `JournalLine` → `schema.prisma:L11588`
- `KdsOrder` → `schema.prisma:L10795`
- `KdsOrderItem` → `schema.prisma:L10812`
- `LearnedPatterns` → `schema.prisma:L6859`
- `LedgerAccount` → `schema.prisma:L11452`
...
- `MarketingCampaign` → `schema.prisma:L9051`
- `McpAuthCode` → `schema.prisma:L11109`
- `McpOAuthClient` → `schema.prisma:L11093`
- `McpRefreshToken` → `schema.prisma:L11127`
- `MeasurementUnit` → `schema.prisma:L10635`
- `Menu` → `schema.prisma:L1326`
- `MenuCategory` → `schema.prisma:L1263`
- `MenuCategoryAssignment` → `schema.prisma:L1361`
- `MercadoPagoWebhookEvent` → `schema.prisma:L11023`
- `MerchantAccount` → `schema.prisma:L3712`
- `MerchantFiscalConfig` → `schema.prisma:L11250`
- `MerchantRevenueShare` → `schema.prisma:L4640`
- `MerchantRoutingRule` → `schema.prisma:L3834`
- `MilestoneAchievement` → `schema.prisma:L8478`
- `Modifier` → `schema.prisma:L2718`
- `ModifierGroup` → `schema.prisma:L2682`
- `Module` → `schema.prisma:L7798`
- `MoneyAnomaly` → `schema.prisma:L4543`
- `MonthlyVenueProfit` → `schema.prisma:L5086`
- `Notification` → `schema.prisma:L5833`
- `NotificationPreference` → `schema.prisma:L5880`
- `NotificationTemplate` → `schema.prisma:L5907`
...
- `OrderDiscount` → `schema.prisma:L5768`
- `OrderItem` → `schema.prisma:L2579`
- `OrderItemModifier` → `schema.prisma:L2767`
- `Organization` → `schema.prisma:L18`
- `OrganizationAttendanceConfig` → `schema.prisma:L8852`
- `OrganizationGoal` → `schema.prisma:L8810`
- `OrganizationModule` → `schema.prisma:L7854`
- `OrganizationPaymentConfig` → `schema.prisma:L4286`
- `OrganizationPayoutConfig` → `schema.prisma:L8885`
- `OrganizationPricingStructure` → `schema.prisma:L4318`
- `OrganizationSalesGoalConfig` → `schema.prisma:L8833`
...
- `PaymentLink` → `schema.prisma:L10330`
- `PaymentLinkAttribution` → `schema.prisma:L10438`
- `PaymentLinkItem` → `schema.prisma:L10393`
- `PaymentLinkItemModifier` → `schema.prisma:L10420`
- `PaymentProvider` → `schema.prisma:L3671`
- `PayrollLine` → `schema.prisma:L11934`
- `PayrollRun` → `schema.prisma:L11903`
- `PerformanceGoal` → `schema.prisma:L8787`
- `PermissionSet` → `schema.prisma:L1091`
- `PlatformCfdi` → `schema.prisma:L12215`
- `PlatformEmisor` → `schema.prisma:L12159`
- `PlatformSettings` → `schema.prisma:L4093`
- `PosCommand` → `schema.prisma:L5961`
- `PosConnectionStatus` → `schema.prisma:L748`
- `PricingPolicy` → `schema.prisma:L1906`
- `Printer` → `schema.prisma:L10841`
- `PrintGateway` → `schema.prisma:L10878`
- `PrintJob` → `schema.prisma:L10925`
- `PrintStation` → `schema.prisma:L10896`
...
- `ProductOption` → `schema.prisma:L10612`
- `ProductOptionValue` → `schema.prisma:L10623`
- `PromoterBankAccount` → `schema.prisma:L12054`
- `PromoterCommissionEntry` → `schema.prisma:L12073`
...
- `Referral` → `schema.prisma:L5433`
- `ReferralProgramConfig` → `schema.prisma:L5398`
- `ReferralRewardGrant` → `schema.prisma:L5524`
- `ReferralTierReward` → `schema.prisma:L5496`
- `ReferralTierUnlock` → `schema.prisma:L5569`
- `Reservation` → `schema.prisma:L9430`
- `ReservationGoogleEventMapping` → `schema.prisma:L10110`
- `ReservationModifier` → `schema.prisma:L9589`
- `ReservationReminderSent` → `schema.prisma:L9572`
- `ReservationSettings` → `schema.prisma:L9750`
- `ReservationWaitlistEntry` → `schema.prisma:L9718`
- `Review` → `schema.prisma:L3250`
- `SalesRetention` → `schema.prisma:L11754`
- `SaleVerification` → `schema.prisma:L3009`
- `ScheduledCommand` → `schema.prisma:L7334`
- `SerializedItem` → `schema.prisma:L7925`
- `SerializedItemCustodyEvent` → `schema.prisma:L8088`
...
- `SimRegistrationRequest` → `schema.prisma:L8126`
- `SimRegistrationRequestItem` → `schema.prisma:L8148`
- `SlotHold` → `schema.prisma:L9629`
- `Staff` → `schema.prisma:L768`
- `StaffOnboardingState` → `schema.prisma:L10993`
- `StaffOrganization` → `schema.prisma:L1005`
- `StaffPasskey` → `schema.prisma:L1032`
- `StaffVenue` → `schema.prisma:L941`
- `StockAlertConfig` → `schema.prisma:L8769`
...
- `TokenPurchase` → `schema.prisma:L7008`
- `TokenUsageRecord` → `schema.prisma:L6980`
- `TpvCommandHistory` → `schema.prisma:L7240`
- `TpvCommandQueue` → `schema.prisma:L7180`
- `TpvFeedback` → `schema.prisma:L6893`
- `TpvMessage` → `schema.prisma:L9126`
- `TpvMessageDelivery` → `schema.prisma:L9178`
- `TpvMessageResponse` → `schema.prisma:L9201`
- `TrainingModule` → `schema.prisma:L9256`
- `TrainingProgress` → `schema.prisma:L9333`
- `TrainingQuizQuestion` → `schema.prisma:L9315`
- `TrainingStep` → `schema.prisma:L9295`
...
- `VenueCommission` → `schema.prisma:L10773`
- `VenueCreditAssessment` → `schema.prisma:L7670`
- `VenueCryptoConfig` → `schema.prisma:L8993`
- `VenueFeature` → `schema.prisma:L3123`
- `VenueModule` → `schema.prisma:L7826`
- `VenuePaymentConfig` → `schema.prisma:L4252`
- `VenuePaymentLinkSettings` → `schema.prisma:L10143`
