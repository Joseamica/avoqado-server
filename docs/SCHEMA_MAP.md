...
- `AccountingPeriodLock` → `schema.prisma:L14402`
- `AccountMapping` → `schema.prisma:L14298`
...
- `AreaTicketExternalIncident` → `schema.prisma:L13571`
- `AreaTicketExternalSettlement` → `schema.prisma:L13536`
...
- `BankStatement` → `schema.prisma:L14172`
- `BankStatementLine` → `schema.prisma:L14193`
- `BillingTaxProfile` → `schema.prisma:L14982`
...
- `CashOutCommissionRate` → `schema.prisma:L14811`
- `CashOutScheduleDay` → `schema.prisma:L14834`
- `CashOutWithdrawal` → `schema.prisma:L14896`
...
- `CustomerTaxProfile` → `schema.prisma:L14144`
...
- `FiscalEmisor` → `schema.prisma:L13998`
- `FiscalLossCarryforward` → `schema.prisma:L14569`
- `FixedAsset` → `schema.prisma:L14587`
- `FixedAssetDepreciation` → `schema.prisma:L14616`
...
- `JournalEntry` → `schema.prisma:L14356`
- `JournalLine` → `schema.prisma:L14384`
- `KdsOrder` → `schema.prisma:L12929`
- `KdsOrderItem` → `schema.prisma:L12946`
- `LearnedPatterns` → `schema.prisma:L7897`
- `LedgerAccount` → `schema.prisma:L14248`
...
- `McpAuthCode` → `schema.prisma:L13881`
- `McpOAuthClient` → `schema.prisma:L13865`
- `McpRefreshToken` → `schema.prisma:L13899`
- `McpToolCall` → `schema.prisma:L13920`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L13795`
- `MerchantAccount` → `schema.prisma:L4373`
- `MerchantFiscalConfig` → `schema.prisma:L14046`
...
- `PromoterBankAccount` → `schema.prisma:L14850`
- `PromoterCommissionEntry` → `schema.prisma:L14869`
...
- `SalesRetention` → `schema.prisma:L14550`
- `SaleVerification` → `schema.prisma:L3577`
- `ScaleProfile` → `schema.prisma:L13444`
...
- `StaffOnboardingState` → `schema.prisma:L13765`
...
- `VenueScaleSettings` → `schema.prisma:L13432`
