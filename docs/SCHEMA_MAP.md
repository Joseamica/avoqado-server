...
- `AccountingPeriodLock` → `schema.prisma:L11199`
- `AccountMapping` → `schema.prisma:L11095`
- `ActivityLog` → `schema.prisma:L4916`
- `Aggregator` → `schema.prisma:L10395`
- `AngelPayUserAccount` → `schema.prisma:L3725`
- `AppUpdate` → `schema.prisma:L8681`
...
- `ClassSession` → `schema.prisma:L9419`
...
- `CreditItemBalance` → `schema.prisma:L10007`
- `CreditOffer` → `schema.prisma:L7498`
- `CreditPack` → `schema.prisma:L9923`
- `CreditPackItem` → `schema.prisma:L9952`
- `CreditPackPurchase` → `schema.prisma:L9969`
- `CreditTransaction` → `schema.prisma:L10029`
- `Customer` → `schema.prisma:L4942`
- `CustomerDiscount` → `schema.prisma:L5516`
- `CustomerGroup` → `schema.prisma:L5096`
- `CustomerTaxProfile` → `schema.prisma:L10941`
...
- `ExternalBusyBlock` → `schema.prisma:L9691`
- `Feature` → `schema.prisma:L3032`
- `FeeSchedule` → `schema.prisma:L3110`
- `FeeTier` → `schema.prisma:L3121`
- `FinancialAccount` → `schema.prisma:L10492`
- `FinancialConnection` → `schema.prisma:L10461`
- `FinancialProvider` → `schema.prisma:L10447`
...
- `GoogleCalendarConnection` → `schema.prisma:L9620`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L9721`
- `GoogleOAuthSession` → `schema.prisma:L9743`
...
- `InventoryTransfer` → `schema.prisma:L10274`
- `Invitation` → `schema.prisma:L1124`
- `Invoice` → `schema.prisma:L3133`
- `InvoiceItem` → `schema.prisma:L3159`
- `ItemCategory` → `schema.prisma:L7630`
- `JournalEntry` → `schema.prisma:L11153`
- `JournalLine` → `schema.prisma:L11181`
- `KdsOrder` → `schema.prisma:L10540`
- `KdsOrderItem` → `schema.prisma:L10557`
- `LearnedPatterns` → `schema.prisma:L6607`
- `LedgerAccount` → `schema.prisma:L11045`
...
- `MarketingCampaign` → `schema.prisma:L8796`
- `McpAuthCode` → `schema.prisma:L10702`
- `McpOAuthClient` → `schema.prisma:L10686`
- `McpRefreshToken` → `schema.prisma:L10720`
- `MeasurementUnit` → `schema.prisma:L10380`
- `Menu` → `schema.prisma:L1305`
- `MenuCategory` → `schema.prisma:L1247`
- `MenuCategoryAssignment` → `schema.prisma:L1340`
- `MercadoPagoWebhookEvent` → `schema.prisma:L10616`
- `MerchantAccount` → `schema.prisma:L3595`
- `MerchantFiscalConfig` → `schema.prisma:L10843`
...
- `OrganizationPayoutConfig` → `schema.prisma:L8630`
...
- `PaymentLink` → `schema.prisma:L10075`
- `PaymentLinkAttribution` → `schema.prisma:L10183`
...
- `Reservation` → `schema.prisma:L9175`
- `ReservationGoogleEventMapping` → `schema.prisma:L9855`
- `ReservationModifier` → `schema.prisma:L9334`
- `ReservationReminderSent` → `schema.prisma:L9317`
- `ReservationSettings` → `schema.prisma:L9495`
- `ReservationWaitlistEntry` → `schema.prisma:L9463`
- `Review` → `schema.prisma:L3177`
- `SalesRetention` → `schema.prisma:L11347`
...
- `SlotHold` → `schema.prisma:L9374`
- `Staff` → `schema.prisma:L752`
- `StaffOnboardingState` → `schema.prisma:L10586`
...
- `TpvMessage` → `schema.prisma:L8871`
- `TpvMessageDelivery` → `schema.prisma:L8923`
- `TpvMessageResponse` → `schema.prisma:L8946`
- `TrainingModule` → `schema.prisma:L9001`
- `TrainingProgress` → `schema.prisma:L9078`
- `TrainingQuizQuestion` → `schema.prisma:L9060`
- `TrainingStep` → `schema.prisma:L9040`
