...
- `AccountingPeriodLock` → `schema.prisma:L15688`
- `AccountMapping` → `schema.prisma:L15584`
- `ActivityLog` → `schema.prisma:L6486`
- `Aggregator` → `schema.prisma:L13985`
- `AngelPayUserAccount` → `schema.prisma:L5149`
- `AppUpdate` → `schema.prisma:L12165`
- `Area` → `schema.prisma:L2941`
- `AreaTicket` → `schema.prisma:L14479`
- `AreaTicketCheckoutSession` → `schema.prisma:L14601`
- `AreaTicketExternalIncident` → `schema.prisma:L14848`
- `AreaTicketExternalSettlement` → `schema.prisma:L14813`
- `AreaTicketFulfillment` → `schema.prisma:L14677`
- `AreaTicketInventoryReservation` → `schema.prisma:L14572`
- `AreaTicketLine` → `schema.prisma:L14540`
- `AreaTicketPaymentAttempt` → `schema.prisma:L14633`
- `AreaTicketPrintAttempt` → `schema.prisma:L14656`
- `BankStatement` → `schema.prisma:L15458`
- `BankStatementLine` → `schema.prisma:L15479`
- `BillingTaxProfile` → `schema.prisma:L16268`
- `BulkCommandOperation` → `schema.prisma:L9453`
- `CalendarSyncOutbox` → `schema.prisma:L13372`
- `CampaignDelivery` → `schema.prisma:L12323`
- `CashCloseout` → `schema.prisma:L9833`
- `CashDeposit` → `schema.prisma:L11967`
- `CashDrawerEvent` → `schema.prisma:L13822`
- `CashDrawerSession` → `schema.prisma:L13798`
- `CashOutCommissionRate` → `schema.prisma:L16097`
- `CashOutScheduleDay` → `schema.prisma:L16120`
- `CashOutWithdrawal` → `schema.prisma:L16182`
...
- `ClassSession` → `schema.prisma:L12976`
- `CommissionCalculation` → `schema.prisma:L11743`
- `CommissionClawback` → `schema.prisma:L11919`
- `CommissionConfig` → `schema.prisma:L11509`
- `CommissionMilestone` → `schema.prisma:L11659`
- `CommissionOverride` → `schema.prisma:L11586`
- `CommissionPayout` → `schema.prisma:L11870`
- `CommissionSummary` → `schema.prisma:L11809`
- `CommissionTier` → `schema.prisma:L11623`
...
- `CreditItemBalance` → `schema.prisma:L13588`
- `CreditOffer` → `schema.prisma:L9961`
- `CreditPack` → `schema.prisma:L13497`
- `CreditPackItem` → `schema.prisma:L13526`
- `CreditPackPurchase` → `schema.prisma:L13543`
- `CreditTransaction` → `schema.prisma:L13610`
...
- `CustomerTaxProfile` → `schema.prisma:L15430`
...
- `EmailTemplate` → `schema.prisma:L12262`
- `Employee` → `schema.prisma:L15945`
- `Estimate` → `schema.prisma:L13892`
- `EstimateItem` → `schema.prisma:L13920`
- `Expense` → `schema.prisma:L15732`
- `ExternalBusyBlock` → `schema.prisma:L13265`
- `Feature` → `schema.prisma:L4273`
- `FeeSchedule` → `schema.prisma:L4351`
- `FeeTier` → `schema.prisma:L4362`
- `FinancialAccount` → `schema.prisma:L14082`
- `FinancialConnection` → `schema.prisma:L14051`
- `FinancialProvider` → `schema.prisma:L14037`
- `FiscalEmisor` → `schema.prisma:L15284`
- `FiscalLossCarryforward` → `schema.prisma:L15855`
- `FixedAsset` → `schema.prisma:L15873`
- `FixedAssetDepreciation` → `schema.prisma:L15902`
- `FloorElement` → `schema.prisma:L3017`
- `FulfillmentArea` → `schema.prisma:L14344`
- `GeofenceRule` → `schema.prisma:L9538`
- `GoogleCalendarChannel` → `schema.prisma:L13242`
- `GoogleCalendarConnection` → `schema.prisma:L13194`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L13295`
- `GoogleOAuthSession` → `schema.prisma:L13317`
...
- `InventoryTransfer` → `schema.prisma:L13864`
...
- `JournalEntry` → `schema.prisma:L15642`
- `JournalLine` → `schema.prisma:L15670`
- `KdsOrder` → `schema.prisma:L14130`
- `KdsOrderItem` → `schema.prisma:L14171`
- `KioskCheckInAttempt` → `schema.prisma:L16591`
- `KioskCheckInChallenge` → `schema.prisma:L16545`
- `KioskOutreachOutbox` → `schema.prisma:L16612`
- `LearnedPatterns` → `schema.prisma:L9023`
- `LedgerAccount` → `schema.prisma:L15534`
...
- `MarketingCampaign` → `schema.prisma:L12280`
- `McpAuthCode` → `schema.prisma:L15167`
- `McpOAuthClient` → `schema.prisma:L15151`
- `McpRefreshToken` → `schema.prisma:L15185`
- `McpToolCall` → `schema.prisma:L15206`
- `MeasurementUnit` → `schema.prisma:L13970`
- `Menu` → `schema.prisma:L1589`
- `MenuCategory` → `schema.prisma:L1526`
- `MenuCategoryAssignment` → `schema.prisma:L1624`
- `MercadoPagoWebhookEvent` → `schema.prisma:L15081`
- `MerchantAccount` → `schema.prisma:L4979`
- `MerchantFiscalConfig` → `schema.prisma:L15332`
- `MerchantRevenueShare` → `schema.prisma:L5990`
- `MerchantRoutingRule` → `schema.prisma:L5101`
- `MilestoneAchievement` → `schema.prisma:L11704`
...
- `OrderFulfillment` → `schema.prisma:L14399`
- `OrderFulfillmentLine` → `schema.prisma:L14430`
- `OrderItem` → `schema.prisma:L3590`
- `OrderItemModifier` → `schema.prisma:L3808`
- `OrderPromotion` → `schema.prisma:L16508`
- `OrderServiceCharge` → `schema.prisma:L7778`
- `Organization` → `schema.prisma:L18`
- `OrganizationAttendanceConfig` → `schema.prisma:L12081`
- `OrganizationEntitlement` → `schema.prisma:L10292`
- `OrganizationGoal` → `schema.prisma:L12039`
- `OrganizationModule` → `schema.prisma:L10069`
- `OrganizationPaymentConfig` → `schema.prisma:L5553`
- `OrganizationPayoutConfig` → `schema.prisma:L12114`
- `OrganizationPricingStructure` → `schema.prisma:L5585`
- `OrganizationSalesGoalConfig` → `schema.prisma:L12062`
...
- `PaymentLink` → `schema.prisma:L13656`
- `PaymentLinkAttribution` → `schema.prisma:L13764`
- `PaymentLinkItem` → `schema.prisma:L13719`
- `PaymentLinkItemModifier` → `schema.prisma:L13746`
- `PaymentProvider` → `schema.prisma:L4938`
- `PayrollLine` → `schema.prisma:L16016`
- `PayrollRun` → `schema.prisma:L15985`
- `PerformanceGoal` → `schema.prisma:L12016`
- `PermissionOverride` → `schema.prisma:L1331`
- `PermissionSet` → `schema.prisma:L1354`
- `PlatformCfdi` → `schema.prisma:L16301`
- `PlatformEmisor` → `schema.prisma:L16241`
- `PlatformSettings` → `schema.prisma:L5360`
- `PosCommand` → `schema.prisma:L7961`
- `PosConnectionStatus` → `schema.prisma:L898`
- `PosSyncIntent` → `schema.prisma:L16379`
- `PricingPolicy` → `schema.prisma:L2514`
- `Printer` → `schema.prisma:L14213`
- `PrintGateway` → `schema.prisma:L14266`
- `PrintJob` → `schema.prisma:L14980`
- `PrintStation` → `schema.prisma:L14284`
...
- `ProductOption` → `schema.prisma:L13947`
- `ProductOptionValue` → `schema.prisma:L13958`
- `ProductStaff` → `schema.prisma:L12891`
- `PromoterBankAccount` → `schema.prisma:L16136`
- `PromoterCommissionEntry` → `schema.prisma:L16155`
- `PromoterLocationPing` → `schema.prisma:L3327`
- `Promotion` → `schema.prisma:L16430`
- `PromotionGroup` → `schema.prisma:L16469`
- `PromotionOption` → `schema.prisma:L16485`
...
- `Reservation` → `schema.prisma:L12659`
- `ReservationGoogleEventMapping` → `schema.prisma:L13429`
- `ReservationModifier` → `schema.prisma:L12839`
- `ReservationReminderSent` → `schema.prisma:L12822`
- `ReservationSettings` → `schema.prisma:L13053`
- `ReservationWaitlistEntry` → `schema.prisma:L13021`
- `Review` → `schema.prisma:L4418`
- `SalesRetention` → `schema.prisma:L15836`
- `SaleVerification` → `schema.prisma:L4177`
- `ScaleProfile` → `schema.prisma:L14721`
...
- `SlotHold` → `schema.prisma:L12922`
- `Staff` → `schema.prisma:L918`
- `StaffDocument` → `schema.prisma:L3198`
- `StaffOnboardingState` → `schema.prisma:L15051`
- `StaffOrganization` → `schema.prisma:L1230`
- `StaffPasskey` → `schema.prisma:L1257`
- `StaffSchedule` → `schema.prisma:L12862`
- `StaffScheduleException` → `schema.prisma:L12874`
...
- `StockAlertConfig` → `schema.prisma:L11998`
...
- `TpvMessage` → `schema.prisma:L12355`
- `TpvMessageDelivery` → `schema.prisma:L12407`
- `TpvMessageResponse` → `schema.prisma:L12430`
- `TrainingModule` → `schema.prisma:L12485`
- `TrainingProgress` → `schema.prisma:L12562`
- `TrainingQuizQuestion` → `schema.prisma:L12544`
- `TrainingStep` → `schema.prisma:L12524`
