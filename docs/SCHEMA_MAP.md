...
- `AccountingPeriodLock` → `schema.prisma:L13128`
- `AccountMapping` → `schema.prisma:L13024`
...
- `BankStatement` → `schema.prisma:L12898`
- `BankStatementLine` → `schema.prisma:L12919`
- `BillingTaxProfile` → `schema.prisma:L13708`
...
- `CashOutCommissionRate` → `schema.prisma:L13537`
- `CashOutScheduleDay` → `schema.prisma:L13560`
- `CashOutWithdrawal` → `schema.prisma:L13622`
- `Cfdi` → `schema.prisma:L12801`
...
- `CustomerTaxProfile` → `schema.prisma:L12870`
...
- `FiscalEmisor` → `schema.prisma:L12724`
- `FiscalLossCarryforward` → `schema.prisma:L13295`
- `FixedAsset` → `schema.prisma:L13313`
- `FixedAssetDepreciation` → `schema.prisma:L13342`
...
- `JournalEntry` → `schema.prisma:L13082`
- `JournalLine` → `schema.prisma:L13110`
- `KdsOrder` → `schema.prisma:L11798`
- `KdsOrderItem` → `schema.prisma:L11815`
- `LearnedPatterns` → `schema.prisma:L7773`
- `LedgerAccount` → `schema.prisma:L12974`
...
- `McpAuthCode` → `schema.prisma:L12607`
- `McpOAuthClient` → `schema.prisma:L12591`
- `McpRefreshToken` → `schema.prisma:L12625`
- `McpToolCall` → `schema.prisma:L12646`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L12521`
- `MerchantAccount` → `schema.prisma:L4264`
- `MerchantFiscalConfig` → `schema.prisma:L12772`
...
- `PromoterBankAccount` → `schema.prisma:L13576`
- `PromoterCommissionEntry` → `schema.prisma:L13595`
...
- `SalesRetention` → `schema.prisma:L13276`
- `SaleVerification` → `schema.prisma:L3475`
- `ScaleProfile` → `schema.prisma:L12291`
...
- `StaffOnboardingState` → `schema.prisma:L12491`
