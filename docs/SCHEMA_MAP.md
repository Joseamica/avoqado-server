...
- `AccountingPeriodLock` → `schema.prisma:L14411`
- `AccountMapping` → `schema.prisma:L14307`
...
- `BankStatement` → `schema.prisma:L14181`
- `BankStatementLine` → `schema.prisma:L14202`
- `BillingTaxProfile` → `schema.prisma:L14991`
...
- `CashOutCommissionRate` → `schema.prisma:L14820`
- `CashOutScheduleDay` → `schema.prisma:L14843`
- `CashOutWithdrawal` → `schema.prisma:L14905`
...
- `CustomerTaxProfile` → `schema.prisma:L14153`
...
- `FiscalEmisor` → `schema.prisma:L14007`
- `FiscalLossCarryforward` → `schema.prisma:L14578`
- `FixedAsset` → `schema.prisma:L14596`
- `FixedAssetDepreciation` → `schema.prisma:L14625`
...
- `JournalEntry` → `schema.prisma:L14365`
- `JournalLine` → `schema.prisma:L14393`
- `KdsOrder` → `schema.prisma:L12929`
- `KdsOrderItem` → `schema.prisma:L12946`
- `LearnedPatterns` → `schema.prisma:L7897`
- `LedgerAccount` → `schema.prisma:L14257`
...
- `McpAuthCode` → `schema.prisma:L13890`
- `McpOAuthClient` → `schema.prisma:L13874`
- `McpRefreshToken` → `schema.prisma:L13908`
- `McpToolCall` → `schema.prisma:L13929`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L13804`
- `MerchantAccount` → `schema.prisma:L4373`
- `MerchantFiscalConfig` → `schema.prisma:L14055`
...
- `PromoterBankAccount` → `schema.prisma:L14859`
- `PromoterCommissionEntry` → `schema.prisma:L14878`
...
- `SalesRetention` → `schema.prisma:L14559`
...
- `StaffOnboardingState` → `schema.prisma:L13774`
