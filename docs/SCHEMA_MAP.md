...
- `AccountingPeriodLock` → `schema.prisma:L16711`
- `AccountMapping` → `schema.prisma:L16607`
...
- `BankStatement` → `schema.prisma:L16481`
- `BankStatementLine` → `schema.prisma:L16502`
- `BillingObligationConflict` → `schema.prisma:L4764`
- `BillingTaxProfile` → `schema.prisma:L17291`
...
- `CashOutCommissionRate` → `schema.prisma:L17120`
- `CashOutScheduleDay` → `schema.prisma:L17143`
- `CashOutWithdrawal` → `schema.prisma:L17205`
...
- `CustomerTaxProfile` → `schema.prisma:L16453`
...
- `FiscalLossCarryforward` → `schema.prisma:L16878`
- `FixedAsset` → `schema.prisma:L16896`
- `FixedAssetDepreciation` → `schema.prisma:L16925`
...
- `JournalEntry` → `schema.prisma:L16665`
- `JournalLine` → `schema.prisma:L16693`
- `KdsOrder` → `schema.prisma:L15117`
- `KdsOrderItem` → `schema.prisma:L15166`
- `KioskCheckInAttempt` → `schema.prisma:L17614`
- `KioskCheckInChallenge` → `schema.prisma:L17568`
- `KioskOutreachOutbox` → `schema.prisma:L17635`
- `LaunchCampaign` → `schema.prisma:L17973`
- `LaunchCampaignRedemption` → `schema.prisma:L18090`
- `LearnedPatterns` → `schema.prisma:L9987`
- `LedgerAccount` → `schema.prisma:L16557`
...
- `MerchantFiscalConfig` → `schema.prisma:L16345`
...
- `OrderPromotion` → `schema.prisma:L17531`
...
- `PaymentEffect` → `schema.prisma:L17905`
...
- `PayrollLine` → `schema.prisma:L17039`
- `PayrollRun` → `schema.prisma:L17008`
- `PerformanceGoal` → `schema.prisma:L12988`
- `PermissionOverride` → `schema.prisma:L1403`
- `PermissionSet` → `schema.prisma:L1426`
- `PlatformAnnouncement` → `schema.prisma:L17695`
- `PlatformAnnouncementClick` → `schema.prisma:L17760`
- `PlatformAnnouncementDelivery` → `schema.prisma:L17797`
- `PlatformCfdi` → `schema.prisma:L17324`
- `PlatformEmisor` → `schema.prisma:L17264`
- `PlatformSettings` → `schema.prisma:L5938`
- `PosCommand` → `schema.prisma:L8917`
- `PosConnectionStatus` → `schema.prisma:L949`
- `PosSyncIntent` → `schema.prisma:L17402`
...
- `PromoterBankAccount` → `schema.prisma:L17159`
- `PromoterCommissionEntry` → `schema.prisma:L17178`
- `PromoterLocationPing` → `schema.prisma:L3693`
- `Promotion` → `schema.prisma:L17453`
- `PromotionGroup` → `schema.prisma:L17492`
- `PromotionOption` → `schema.prisma:L17508`
...
- `ReceiptLayout` → `schema.prisma:L17939`
...
- `RefreshGrant` → `schema.prisma:L17884`
...
- `SalesRetention` → `schema.prisma:L16859`
