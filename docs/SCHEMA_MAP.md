...
- `AccountingPeriodLock` → `schema.prisma:L11162`
- `AccountMapping` → `schema.prisma:L11062`
...
- `BankStatement` → `schema.prisma:L10936`
- `BankStatementLine` → `schema.prisma:L10957`
- `BillingTaxProfile` → `schema.prisma:L11651`
...
- `CashOutCommissionRate` → `schema.prisma:L11480`
- `CashOutScheduleDay` → `schema.prisma:L11503`
- `CashOutWithdrawal` → `schema.prisma:L11565`
- `Cfdi` → `schema.prisma:L10839`
...
- `CustomerTaxProfile` → `schema.prisma:L10908`
...
- `FinancialAccount` → `schema.prisma:L10478`
- `FinancialConnection` → `schema.prisma:L10447`
- `FinancialProvider` → `schema.prisma:L10433`
- `FiscalEmisor` → `schema.prisma:L10781`
...
- `JournalEntry` → `schema.prisma:L11116`
- `JournalLine` → `schema.prisma:L11144`
- `KdsOrder` → `schema.prisma:L10526`
- `KdsOrderItem` → `schema.prisma:L10543`
- `LearnedPatterns` → `schema.prisma:L6597`
- `LedgerAccount` → `schema.prisma:L11012`
...
- `McpAuthCode` → `schema.prisma:L10688`
- `McpOAuthClient` → `schema.prisma:L10672`
- `McpRefreshToken` → `schema.prisma:L10706`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L10602`
- `MerchantAccount` → `schema.prisma:L3585`
- `MerchantFiscalConfig` → `schema.prisma:L10817`
...
- `PayrollLine` → `schema.prisma:L11399`
- `PayrollRun` → `schema.prisma:L11368`
- `PerformanceGoal` → `schema.prisma:L8525`
- `PermissionSet` → `schema.prisma:L1074`
- `PlatformCfdi` → `schema.prisma:L11680`
- `PlatformEmisor` → `schema.prisma:L11624`
...
- `PromoterBankAccount` → `schema.prisma:L11519`
- `PromoterCommissionEntry` → `schema.prisma:L11538`
...
- `StaffOnboardingState` → `schema.prisma:L10572`
...
- `VenueCommission` → `schema.prisma:L10504`
