...
- `AccountingPeriodLock` → `schema.prisma:L16230`
- `AccountMapping` → `schema.prisma:L16126`
- `ActivityLog` → `schema.prisma:L6742`
- `Aggregator` → `schema.prisma:L14523`
- `AngelPayUserAccount` → `schema.prisma:L5405`
- `AppUpdate` → `schema.prisma:L12688`
- `Area` → `schema.prisma:L3038`
- `AreaTicket` → `schema.prisma:L15021`
- `AreaTicketCheckoutSession` → `schema.prisma:L15143`
- `AreaTicketExternalIncident` → `schema.prisma:L15390`
- `AreaTicketExternalSettlement` → `schema.prisma:L15355`
- `AreaTicketFulfillment` → `schema.prisma:L15219`
- `AreaTicketInventoryReservation` → `schema.prisma:L15114`
- `AreaTicketLine` → `schema.prisma:L15082`
- `AreaTicketPaymentAttempt` → `schema.prisma:L15175`
- `AreaTicketPrintAttempt` → `schema.prisma:L15198`
- `BankStatement` → `schema.prisma:L16000`
- `BankStatementLine` → `schema.prisma:L16021`
- `BillingTaxProfile` → `schema.prisma:L16810`
- `BirthdayAutomation` → `schema.prisma:L7059`
- `BulkCommandOperation` → `schema.prisma:L9968`
- `CalendarSyncOutbox` → `schema.prisma:L13895`
- `CampaignDelivery` → `schema.prisma:L12846`
- `CashCloseout` → `schema.prisma:L10353`
- `CashDeposit` → `schema.prisma:L12490`
- `CashDrawerEvent` → `schema.prisma:L14360`
- `CashDrawerSession` → `schema.prisma:L14321`
- `CashOutCommissionRate` → `schema.prisma:L16639`
- `CashOutScheduleDay` → `schema.prisma:L16662`
- `CashOutWithdrawal` → `schema.prisma:L16724`
- `CatalogBindingBatch` → `schema.prisma:L11384`
- `CatalogBindingLine` → `schema.prisma:L11420`
- `CatalogBrand` → `schema.prisma:L10837`
- `CatalogClientObservation` → `schema.prisma:L11150`
- `CatalogClientReadinessOverride` → `schema.prisma:L11169`
- `CatalogFamily` → `schema.prisma:L10887`
- `CatalogIdempotencyRecord` → `schema.prisma:L11283`
- `CatalogIdentifier` → `schema.prisma:L11018`
- `CatalogImportBatch` → `schema.prisma:L11326`
- `CatalogImportLine` → `schema.prisma:L11363`
- `CatalogItem` → `schema.prisma:L10920`
- `CatalogItemBusinessType` → `schema.prisma:L10980`
- `CatalogItemPrice` → `schema.prisma:L11068`
- `CatalogManufacturer` → `schema.prisma:L10861`
- `CatalogProductTypeMapping` → `schema.prisma:L10997`
- `CatalogPublicationBatch` → `schema.prisma:L11448`
- `CatalogPublicationFieldDecision` → `schema.prisma:L11542`
- `CatalogPublicationLine` → `schema.prisma:L11489`
- `CatalogPublicationOutbox` → `schema.prisma:L11585`
- `CatalogValidationProfile` → `schema.prisma:L11039`
- `CatalogVenueBinding` → `schema.prisma:L11197`
- `CatalogVenueClientRequirement` → `schema.prisma:L11124`
- `CatalogVenueEventSequence` → `schema.prisma:L11568`
- `CatalogVenueOverride` → `schema.prisma:L11239`
- `CatalogVenueRollout` → `schema.prisma:L11099`
- `Cfdi` → `schema.prisma:L15903`
- `ChatbotTokenBudget` → `schema.prisma:L9616`
- `ChatConversation` → `schema.prisma:L9471`
- `ChatFeedback` → `schema.prisma:L9557`
- `ChatLearningEvent` → `schema.prisma:L9514`
- `ChatMessage` → `schema.prisma:L9494`
- `ChatTrainingData` → `schema.prisma:L9428`
- `CheckoutSession` → `schema.prisma:L5685`
- `ClassSession` → `schema.prisma:L13499`
- `CommissionCalculation` → `schema.prisma:L12266`
- `CommissionClawback` → `schema.prisma:L12442`
- `CommissionConfig` → `schema.prisma:L12032`
- `CommissionMilestone` → `schema.prisma:L12182`
- `CommissionOverride` → `schema.prisma:L12109`
- `CommissionPayout` → `schema.prisma:L12393`
- `CommissionSummary` → `schema.prisma:L12332`
- `CommissionTier` → `schema.prisma:L12146`
...
- `CreditAssessmentHistory` → `schema.prisma:L10462`
- `CreditItemBalance` → `schema.prisma:L14111`
- `CreditOffer` → `schema.prisma:L10481`
- `CreditPack` → `schema.prisma:L14020`
- `CreditPackItem` → `schema.prisma:L14049`
- `CreditPackPurchase` → `schema.prisma:L14066`
- `CreditTransaction` → `schema.prisma:L14133`
- `Customer` → `schema.prisma:L6783`
- `CustomerApprovalDelivery` → `schema.prisma:L9130`
- `CustomerApprovalOutbox` → `schema.prisma:L9105`
...
- `CustomerTaxProfile` → `schema.prisma:L15972`
...
- `EmailTemplate` → `schema.prisma:L12785`
- `Employee` → `schema.prisma:L16487`
- `Estimate` → `schema.prisma:L14430`
- `EstimateItem` → `schema.prisma:L14458`
- `Expense` → `schema.prisma:L16274`
- `ExternalBusyBlock` → `schema.prisma:L13788`
- `Feature` → `schema.prisma:L4508`
- `FeeSchedule` → `schema.prisma:L4586`
- `FeeTier` → `schema.prisma:L4597`
- `FinancialAccount` → `schema.prisma:L14620`
- `FinancialConnection` → `schema.prisma:L14589`
- `FinancialProvider` → `schema.prisma:L14575`
- `FiscalEmisor` → `schema.prisma:L15826`
- `FiscalLossCarryforward` → `schema.prisma:L16397`
- `FixedAsset` → `schema.prisma:L16415`
- `FixedAssetDepreciation` → `schema.prisma:L16444`
- `FloorElement` → `schema.prisma:L3114`
- `FulfillmentArea` → `schema.prisma:L14886`
- `GeofenceRule` → `schema.prisma:L10053`
- `GoogleCalendarChannel` → `schema.prisma:L13765`
- `GoogleCalendarConnection` → `schema.prisma:L13717`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L13818`
- `GoogleOAuthSession` → `schema.prisma:L13840`
- `HolidayCalendar` → `schema.prisma:L6666`
- `IdempotencyRequest` → `schema.prisma:L11907`
...
- `InventoryTransfer` → `schema.prisma:L14402`
- `Invitation` → `schema.prisma:L1450`
- `Invoice` → `schema.prisma:L4609`
- `InvoiceItem` → `schema.prisma:L4635`
- `ItemCategory` → `schema.prisma:L11620`
- `JournalEntry` → `schema.prisma:L16184`
- `JournalLine` → `schema.prisma:L16212`
- `KdsOrder` → `schema.prisma:L14668`
- `KdsOrderItem` → `schema.prisma:L14709`
- `KioskCheckInAttempt` → `schema.prisma:L17133`
- `KioskCheckInChallenge` → `schema.prisma:L17087`
- `KioskOutreachOutbox` → `schema.prisma:L17154`
- `LearnedPatterns` → `schema.prisma:L9538`
- `LedgerAccount` → `schema.prisma:L16076`
...
- `MarketingCampaign` → `schema.prisma:L12803`
- `McpAuthCode` → `schema.prisma:L15709`
- `McpOAuthClient` → `schema.prisma:L15693`
- `McpRefreshToken` → `schema.prisma:L15727`
- `McpToolCall` → `schema.prisma:L15748`
- `MeasurementUnit` → `schema.prisma:L14508`
- `Menu` → `schema.prisma:L1636`
- `MenuCategory` → `schema.prisma:L1573`
- `MenuCategoryAssignment` → `schema.prisma:L1671`
- `MercadoPagoWebhookEvent` → `schema.prisma:L15623`
- `MerchantAccount` → `schema.prisma:L5235`
- `MerchantFiscalConfig` → `schema.prisma:L15874`
- `MerchantRevenueShare` → `schema.prisma:L6246`
- `MerchantRoutingRule` → `schema.prisma:L5357`
- `MilestoneAchievement` → `schema.prisma:L12227`
- `Modifier` → `schema.prisma:L3992`
- `ModifierGroup` → `schema.prisma:L3956`
- `Module` → `schema.prisma:L10529`
...
- `OrderFulfillment` → `schema.prisma:L14941`
- `OrderFulfillmentLine` → `schema.prisma:L14972`
- `OrderItem` → `schema.prisma:L3823`
- `OrderItemModifier` → `schema.prisma:L4041`
- `OrderPromotion` → `schema.prisma:L17050`
- `OrderServiceCharge` → `schema.prisma:L8290`
- `Organization` → `schema.prisma:L18`
- `OrganizationAttendanceConfig` → `schema.prisma:L12604`
- `OrganizationEntitlement` → `schema.prisma:L10812`
- `OrganizationGoal` → `schema.prisma:L12562`
- `OrganizationModule` → `schema.prisma:L10589`
- `OrganizationPaymentConfig` → `schema.prisma:L5809`
- `OrganizationPayoutConfig` → `schema.prisma:L12637`
- `OrganizationPricingStructure` → `schema.prisma:L5841`
- `OrganizationSalesGoalConfig` → `schema.prisma:L12585`
...
- `PaymentLink` → `schema.prisma:L14179`
- `PaymentLinkAttribution` → `schema.prisma:L14287`
- `PaymentLinkItem` → `schema.prisma:L14242`
- `PaymentLinkItemModifier` → `schema.prisma:L14269`
- `PaymentProvider` → `schema.prisma:L5194`
- `PayrollLine` → `schema.prisma:L16558`
- `PayrollRun` → `schema.prisma:L16527`
- `PerformanceGoal` → `schema.prisma:L12539`
- `PermissionOverride` → `schema.prisma:L1374`
- `PermissionSet` → `schema.prisma:L1397`
- `PlatformAnnouncement` → `schema.prisma:L17214`
- `PlatformAnnouncementClick` → `schema.prisma:L17279`
- `PlatformAnnouncementDelivery` → `schema.prisma:L17316`
- `PlatformCfdi` → `schema.prisma:L16843`
- `PlatformEmisor` → `schema.prisma:L16783`
- `PlatformSettings` → `schema.prisma:L5616`
- `PosCommand` → `schema.prisma:L8473`
- `PosConnectionStatus` → `schema.prisma:L921`
- `PosSyncIntent` → `schema.prisma:L16921`
- `PricingPolicy` → `schema.prisma:L2611`
- `Printer` → `schema.prisma:L14751`
- `PrintGateway` → `schema.prisma:L14808`
- `PrintJob` → `schema.prisma:L15522`
- `PrintStation` → `schema.prisma:L14826`
...
- `ProductOption` → `schema.prisma:L14485`
- `ProductOptionValue` → `schema.prisma:L14496`
- `ProductStaff` → `schema.prisma:L13414`
- `PromoterBankAccount` → `schema.prisma:L16678`
- `PromoterCommissionEntry` → `schema.prisma:L16697`
- `PromoterLocationPing` → `schema.prisma:L3529`
- `Promotion` → `schema.prisma:L16972`
- `PromotionGroup` → `schema.prisma:L17011`
- `PromotionOption` → `schema.prisma:L17027`
...
- `RefreshGrant` → `schema.prisma:L17403`
- `Reservation` → `schema.prisma:L13182`
- `ReservationGoogleEventMapping` → `schema.prisma:L13952`
- `ReservationModifier` → `schema.prisma:L13362`
- `ReservationReminderSent` → `schema.prisma:L13345`
- `ReservationSettings` → `schema.prisma:L13576`
- `ReservationWaitlistEntry` → `schema.prisma:L13544`
- `Review` → `schema.prisma:L4653`
- `SalesRetention` → `schema.prisma:L16378`
- `SaleVerification` → `schema.prisma:L4412`
- `ScaleProfile` → `schema.prisma:L15263`
- `ScheduledCommand` → `schema.prisma:L10013`
- `SerializedItem` → `schema.prisma:L11663`
- `SerializedItemCustodyEvent` → `schema.prisma:L11830`
- `ServiceCharge` → `schema.prisma:L8261`
- `Session` → `schema.prisma:L17382`
...
- `SimRegistrationRequest` → `schema.prisma:L11868`
- `SimRegistrationRequestItem` → `schema.prisma:L11890`
- `SlotHold` → `schema.prisma:L13445`
- `Staff` → `schema.prisma:L941`
- `StaffDocument` → `schema.prisma:L3400`
- `StaffOnboardingState` → `schema.prisma:L15593`
- `StaffOrganization` → `schema.prisma:L1273`
- `StaffPasskey` → `schema.prisma:L1300`
- `StaffSchedule` → `schema.prisma:L13385`
- `StaffScheduleException` → `schema.prisma:L13397`
...
- `StockAlertConfig` → `schema.prisma:L12521`
...
- `TokenPurchase` → `schema.prisma:L9687`
- `TokenUsageRecord` → `schema.prisma:L9659`
- `TpvCommandHistory` → `schema.prisma:L9919`
- `TpvCommandQueue` → `schema.prisma:L9859`
- `TpvFeedback` → `schema.prisma:L9572`
- `TpvMessage` → `schema.prisma:L12878`
- `TpvMessageDelivery` → `schema.prisma:L12930`
- `TpvMessageResponse` → `schema.prisma:L12953`
- `TrainingModule` → `schema.prisma:L13008`
- `TrainingProgress` → `schema.prisma:L13085`
- `TrainingQuizQuestion` → `schema.prisma:L13067`
- `TrainingStep` → `schema.prisma:L13047`
...
- `VenueAreaTicketSettings` → `schema.prisma:L15000`
- `VenueChatMessage` → `schema.prisma:L771`
- `VenueChatSession` → `schema.prisma:L726`
- `VenueCommission` → `schema.prisma:L14646`
- `VenueCreditAssessment` → `schema.prisma:L10401`
- `VenueCryptoConfig` → `schema.prisma:L12745`
- `VenueFeature` → `schema.prisma:L4526`
- `VenueModule` → `schema.prisma:L10561`
- `VenuePaymentConfig` → `schema.prisma:L5775`
- `VenuePaymentLinkSettings` → `schema.prisma:L13985`
- `VenuePricingStructure` → `schema.prisma:L6274`
- `VenueRoleConfig` → `schema.prisma:L1426`
- `VenueRolePermission` → `schema.prisma:L1330`
- `VenueScaleSettings` → `schema.prisma:L15251`
