...
- `AccountingPeriodLock` → `schema.prisma:L15966`
- `AccountMapping` → `schema.prisma:L15862`
- `ActivityLog` → `schema.prisma:L6732`
- `Aggregator` → `schema.prisma:L14259`
- `AngelPayUserAccount` → `schema.prisma:L5395`
- `AppUpdate` → `schema.prisma:L12424`
- `Area` → `schema.prisma:L3028`
- `AreaTicket` → `schema.prisma:L14757`
- `AreaTicketCheckoutSession` → `schema.prisma:L14879`
- `AreaTicketExternalIncident` → `schema.prisma:L15126`
- `AreaTicketExternalSettlement` → `schema.prisma:L15091`
- `AreaTicketFulfillment` → `schema.prisma:L14955`
- `AreaTicketInventoryReservation` → `schema.prisma:L14850`
- `AreaTicketLine` → `schema.prisma:L14818`
- `AreaTicketPaymentAttempt` → `schema.prisma:L14911`
- `AreaTicketPrintAttempt` → `schema.prisma:L14934`
- `BankStatement` → `schema.prisma:L15736`
- `BankStatementLine` → `schema.prisma:L15757`
- `BillingTaxProfile` → `schema.prisma:L16546`
- `BulkCommandOperation` → `schema.prisma:L9704`
- `CalendarSyncOutbox` → `schema.prisma:L13631`
- `CampaignDelivery` → `schema.prisma:L12582`
- `CashCloseout` → `schema.prisma:L10089`
- `CashDeposit` → `schema.prisma:L12226`
- `CashDrawerEvent` → `schema.prisma:L14096`
- `CashDrawerSession` → `schema.prisma:L14057`
- `CashOutCommissionRate` → `schema.prisma:L16375`
- `CashOutScheduleDay` → `schema.prisma:L16398`
- `CashOutWithdrawal` → `schema.prisma:L16460`
- `CatalogBindingBatch` → `schema.prisma:L11120`
- `CatalogBindingLine` → `schema.prisma:L11156`
- `CatalogBrand` → `schema.prisma:L10573`
- `CatalogClientObservation` → `schema.prisma:L10886`
- `CatalogClientReadinessOverride` → `schema.prisma:L10905`
- `CatalogFamily` → `schema.prisma:L10623`
- `CatalogIdempotencyRecord` → `schema.prisma:L11019`
- `CatalogIdentifier` → `schema.prisma:L10754`
- `CatalogImportBatch` → `schema.prisma:L11062`
- `CatalogImportLine` → `schema.prisma:L11099`
- `CatalogItem` → `schema.prisma:L10656`
- `CatalogItemBusinessType` → `schema.prisma:L10716`
- `CatalogItemPrice` → `schema.prisma:L10804`
- `CatalogManufacturer` → `schema.prisma:L10597`
- `CatalogProductTypeMapping` → `schema.prisma:L10733`
- `CatalogPublicationBatch` → `schema.prisma:L11184`
- `CatalogPublicationFieldDecision` → `schema.prisma:L11278`
- `CatalogPublicationLine` → `schema.prisma:L11225`
- `CatalogPublicationOutbox` → `schema.prisma:L11321`
- `CatalogValidationProfile` → `schema.prisma:L10775`
- `CatalogVenueBinding` → `schema.prisma:L10933`
- `CatalogVenueClientRequirement` → `schema.prisma:L10860`
- `CatalogVenueEventSequence` → `schema.prisma:L11304`
- `CatalogVenueOverride` → `schema.prisma:L10975`
- `CatalogVenueRollout` → `schema.prisma:L10835`
- `Cfdi` → `schema.prisma:L15639`
- `ChatbotTokenBudget` → `schema.prisma:L9352`
- `ChatConversation` → `schema.prisma:L9207`
- `ChatFeedback` → `schema.prisma:L9293`
- `ChatLearningEvent` → `schema.prisma:L9250`
- `ChatMessage` → `schema.prisma:L9230`
- `ChatTrainingData` → `schema.prisma:L9164`
...
- `CouponCode` → `schema.prisma:L7859`
- `CouponRedemption` → `schema.prisma:L7890`
- `CreditAssessmentHistory` → `schema.prisma:L10198`
- `CreditItemBalance` → `schema.prisma:L13847`
- `CreditOffer` → `schema.prisma:L10217`
...
- `CustomerApprovalDelivery` → `schema.prisma:L8866`
- `CustomerApprovalOutbox` → `schema.prisma:L8841`
- `CustomerDiscount` → `schema.prisma:L7910`
- `CustomerGroup` → `schema.prisma:L6959`
- `CustomerOrderMetric` → `schema.prisma:L3798`
- `CustomerTaxProfile` → `schema.prisma:L15708`
...
- `DeviceToken` → `schema.prisma:L8179`
- `DigitalReceipt` → `schema.prisma:L4369`
- `Discount` → `schema.prisma:L7549`
- `EcommerceMerchant` → `schema.prisma:L5487`
- `EmailTemplate` → `schema.prisma:L12521`
- `Employee` → `schema.prisma:L16223`
- `Estimate` → `schema.prisma:L14166`
- `EstimateItem` → `schema.prisma:L14194`
- `Expense` → `schema.prisma:L16010`
...
- `FinancialAccount` → `schema.prisma:L14356`
- `FinancialConnection` → `schema.prisma:L14325`
- `FinancialProvider` → `schema.prisma:L14311`
- `FiscalEmisor` → `schema.prisma:L15562`
- `FiscalLossCarryforward` → `schema.prisma:L16133`
- `FixedAsset` → `schema.prisma:L16151`
- `FixedAssetDepreciation` → `schema.prisma:L16180`
- `FloorElement` → `schema.prisma:L3104`
- `FulfillmentArea` → `schema.prisma:L14622`
- `GeofenceRule` → `schema.prisma:L9789`
...
- `InventoryTransfer` → `schema.prisma:L14138`
- `Invitation` → `schema.prisma:L1440`
- `Invoice` → `schema.prisma:L4599`
- `InvoiceItem` → `schema.prisma:L4625`
- `ItemCategory` → `schema.prisma:L11356`
- `JournalEntry` → `schema.prisma:L15920`
- `JournalLine` → `schema.prisma:L15948`
- `KdsOrder` → `schema.prisma:L14404`
- `KdsOrderItem` → `schema.prisma:L14445`
- `KioskCheckInAttempt` → `schema.prisma:L16869`
- `KioskCheckInChallenge` → `schema.prisma:L16823`
- `KioskOutreachOutbox` → `schema.prisma:L16890`
- `LearnedPatterns` → `schema.prisma:L9274`
- `LedgerAccount` → `schema.prisma:L15812`
...
- `McpAuthCode` → `schema.prisma:L15445`
- `McpOAuthClient` → `schema.prisma:L15429`
- `McpRefreshToken` → `schema.prisma:L15463`
- `McpToolCall` → `schema.prisma:L15484`
- `MeasurementUnit` → `schema.prisma:L14244`
- `Menu` → `schema.prisma:L1626`
- `MenuCategory` → `schema.prisma:L1563`
- `MenuCategoryAssignment` → `schema.prisma:L1661`
- `MercadoPagoWebhookEvent` → `schema.prisma:L15359`
- `MerchantAccount` → `schema.prisma:L5225`
- `MerchantFiscalConfig` → `schema.prisma:L15610`
...
- `Module` → `schema.prisma:L10265`
- `MoneyAnomaly` → `schema.prisma:L6139`
- `MonthlyVenueProfit` → `schema.prisma:L6682`
- `Notification` → `schema.prisma:L8081`
- `NotificationPreference` → `schema.prisma:L8128`
- `NotificationTemplate` → `schema.prisma:L8155`
...
- `OrderDiscount` → `schema.prisma:L7942`
- `OrderFulfillment` → `schema.prisma:L14677`
- `OrderFulfillmentLine` → `schema.prisma:L14708`
- `OrderItem` → `schema.prisma:L3813`
- `OrderItemModifier` → `schema.prisma:L4031`
- `OrderPromotion` → `schema.prisma:L16786`
- `OrderServiceCharge` → `schema.prisma:L8026`
- `Organization` → `schema.prisma:L18`
- `OrganizationAttendanceConfig` → `schema.prisma:L12340`
- `OrganizationEntitlement` → `schema.prisma:L10548`
- `OrganizationGoal` → `schema.prisma:L12298`
- `OrganizationModule` → `schema.prisma:L10325`
...
- `PayrollLine` → `schema.prisma:L16294`
- `PayrollRun` → `schema.prisma:L16263`
- `PerformanceGoal` → `schema.prisma:L12275`
- `PermissionOverride` → `schema.prisma:L1364`
- `PermissionSet` → `schema.prisma:L1387`
- `PlatformAnnouncement` → `schema.prisma:L16950`
- `PlatformAnnouncementClick` → `schema.prisma:L17015`
- `PlatformAnnouncementDelivery` → `schema.prisma:L17052`
- `PlatformCfdi` → `schema.prisma:L16579`
- `PlatformEmisor` → `schema.prisma:L16519`
- `PlatformSettings` → `schema.prisma:L5606`
- `PosCommand` → `schema.prisma:L8209`
- `PosConnectionStatus` → `schema.prisma:L911`
- `PosSyncIntent` → `schema.prisma:L16657`
- `PricingPolicy` → `schema.prisma:L2601`
- `Printer` → `schema.prisma:L14487`
- `PrintGateway` → `schema.prisma:L14544`
- `PrintJob` → `schema.prisma:L15258`
- `PrintStation` → `schema.prisma:L14562`
...
- `ProductOption` → `schema.prisma:L14221`
- `ProductOptionValue` → `schema.prisma:L14232`
- `ProductStaff` → `schema.prisma:L13150`
- `PromoterBankAccount` → `schema.prisma:L16414`
- `PromoterCommissionEntry` → `schema.prisma:L16433`
- `PromoterLocationPing` → `schema.prisma:L3519`
- `Promotion` → `schema.prisma:L16708`
- `PromotionGroup` → `schema.prisma:L16747`
- `PromotionOption` → `schema.prisma:L16763`
...
- `Referral` → `schema.prisma:L7397`
- `ReferralProgramConfig` → `schema.prisma:L7362`
- `ReferralRewardGrant` → `schema.prisma:L7488`
- `ReferralTierReward` → `schema.prisma:L7460`
- `ReferralTierUnlock` → `schema.prisma:L7533`
- `RefreshGrant` → `schema.prisma:L17139`
...
- `SalesRetention` → `schema.prisma:L16114`
- `SaleVerification` → `schema.prisma:L4402`
- `ScaleProfile` → `schema.prisma:L14999`
- `ScheduledCommand` → `schema.prisma:L9749`
- `SerializedItem` → `schema.prisma:L11399`
- `SerializedItemCustodyEvent` → `schema.prisma:L11566`
- `ServiceCharge` → `schema.prisma:L7997`
- `Session` → `schema.prisma:L17118`
...
- `StaffOnboardingState` → `schema.prisma:L15329`
...
- `StampCard` → `schema.prisma:L7245`
- `StampEvent` → `schema.prisma:L7284`
- `StampReward` → `schema.prisma:L7322`
...
- `TokenPurchase` → `schema.prisma:L9423`
- `TokenUsageRecord` → `schema.prisma:L9395`
- `TpvCommandHistory` → `schema.prisma:L9655`
- `TpvCommandQueue` → `schema.prisma:L9595`
- `TpvFeedback` → `schema.prisma:L9308`
...
- `UpsellAcceptance` → `schema.prisma:L7818`
- `UpsellAiRun` → `schema.prisma:L7838`
- `UpsellImpression` → `schema.prisma:L7778`
- `UpsellRule` → `schema.prisma:L7698`
- `user_sessions` → `schema.prisma:L5664`
- `Venue` → `schema.prisma:L159`
- `VenueAreaTicketSettings` → `schema.prisma:L14736`
- `VenueChatMessage` → `schema.prisma:L761`
- `VenueChatSession` → `schema.prisma:L716`
- `VenueCommission` → `schema.prisma:L14382`
- `VenueCreditAssessment` → `schema.prisma:L10137`
- `VenueCryptoConfig` → `schema.prisma:L12481`
- `VenueFeature` → `schema.prisma:L4516`
- `VenueModule` → `schema.prisma:L10297`
...
- `VenueScaleSettings` → `schema.prisma:L14987`
...
- `WalletCardDesign` → `schema.prisma:L7163`
- `WalletPass` → `schema.prisma:L7072`
- `WalletPassRegistration` → `schema.prisma:L7130`
