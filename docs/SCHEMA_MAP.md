...
- `AccountingPeriodLock` → `schema.prisma:L11163`
- `AccountMapping` → `schema.prisma:L11063`
...
- `BankStatement` → `schema.prisma:L10937`
- `BankStatementLine` → `schema.prisma:L10958`
- `BillingTaxProfile` → `schema.prisma:L11652`
...
- `CashOutCommissionRate` → `schema.prisma:L11481`
- `CashOutScheduleDay` → `schema.prisma:L11504`
- `CashOutWithdrawal` → `schema.prisma:L11566`
- `Cfdi` → `schema.prisma:L10840`
...
- `CustomerTaxProfile` → `schema.prisma:L10909`
...
- `JournalEntry` → `schema.prisma:L11117`
- `JournalLine` → `schema.prisma:L11145`
- `KdsOrder` → `schema.prisma:L10527`
- `KdsOrderItem` → `schema.prisma:L10544`
- `LearnedPatterns` → `schema.prisma:L6598`
- `LedgerAccount` → `schema.prisma:L11013`
...
- `MerchantFiscalConfig` → `schema.prisma:L10818`
...
- `PayrollLine` → `schema.prisma:L11400`
- `PayrollRun` → `schema.prisma:L11369`
- `PerformanceGoal` → `schema.prisma:L8526`
- `PermissionSet` → `schema.prisma:L1075`
- `PlatformCfdi` → `schema.prisma:L11681`
- `PlatformEmisor` → `schema.prisma:L11625`
...
- `PromoterBankAccount` → `schema.prisma:L11520`
- `PromoterCommissionEntry` → `schema.prisma:L11539`
