...
- `AccountingPeriodLock` → `schema.prisma:L15881`
- `AccountMapping` → `schema.prisma:L15777`
...
- `AreaTicket` → `schema.prisma:L14672`
- `AreaTicketCheckoutSession` → `schema.prisma:L14794`
- `AreaTicketExternalIncident` → `schema.prisma:L15041`
- `AreaTicketExternalSettlement` → `schema.prisma:L15006`
- `AreaTicketFulfillment` → `schema.prisma:L14870`
- `AreaTicketInventoryReservation` → `schema.prisma:L14765`
- `AreaTicketLine` → `schema.prisma:L14733`
- `AreaTicketPaymentAttempt` → `schema.prisma:L14826`
- `AreaTicketPrintAttempt` → `schema.prisma:L14849`
- `BankStatement` → `schema.prisma:L15651`
- `BankStatementLine` → `schema.prisma:L15672`
- `BillingTaxProfile` → `schema.prisma:L16461`
...
- `CashOutCommissionRate` → `schema.prisma:L16290`
- `CashOutScheduleDay` → `schema.prisma:L16313`
- `CashOutWithdrawal` → `schema.prisma:L16375`
...
- `CustomerTaxProfile` → `schema.prisma:L15623`
...
- `FiscalEmisor` → `schema.prisma:L15477`
- `FiscalLossCarryforward` → `schema.prisma:L16048`
- `FixedAsset` → `schema.prisma:L16066`
- `FixedAssetDepreciation` → `schema.prisma:L16095`
- `FloorElement` → `schema.prisma:L3098`
- `FulfillmentArea` → `schema.prisma:L14537`
...
- `JournalEntry` → `schema.prisma:L15835`
- `JournalLine` → `schema.prisma:L15863`
- `KdsOrder` → `schema.prisma:L14319`
- `KdsOrderItem` → `schema.prisma:L14360`
- `KioskCheckInAttempt` → `schema.prisma:L16784`
- `KioskCheckInChallenge` → `schema.prisma:L16738`
- `KioskOutreachOutbox` → `schema.prisma:L16805`
- `LearnedPatterns` → `schema.prisma:L9207`
- `LedgerAccount` → `schema.prisma:L15727`
...
- `McpAuthCode` → `schema.prisma:L15360`
- `McpOAuthClient` → `schema.prisma:L15344`
- `McpRefreshToken` → `schema.prisma:L15378`
- `McpToolCall` → `schema.prisma:L15399`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L15274`
- `MerchantAccount` → `schema.prisma:L5159`
- `MerchantFiscalConfig` → `schema.prisma:L15525`
...
- `OrderFulfillment` → `schema.prisma:L14592`
- `OrderFulfillmentLine` → `schema.prisma:L14623`
- `OrderItem` → `schema.prisma:L3758`
- `OrderItemModifier` → `schema.prisma:L3976`
- `OrderPromotion` → `schema.prisma:L16701`
...
- `PayrollLine` → `schema.prisma:L16209`
- `PayrollRun` → `schema.prisma:L16178`
- `PerformanceGoal` → `schema.prisma:L12205`
- `PermissionOverride` → `schema.prisma:L1362`
- `PermissionSet` → `schema.prisma:L1385`
- `PlatformAnnouncement` → `schema.prisma:L16865`
- `PlatformAnnouncementClick` → `schema.prisma:L16930`
- `PlatformAnnouncementDelivery` → `schema.prisma:L16967`
- `PlatformCfdi` → `schema.prisma:L16494`
- `PlatformEmisor` → `schema.prisma:L16434`
- `PlatformSettings` → `schema.prisma:L5540`
- `PosCommand` → `schema.prisma:L8142`
- `PosConnectionStatus` → `schema.prisma:L911`
- `PosSyncIntent` → `schema.prisma:L16572`
- `PricingPolicy` → `schema.prisma:L2595`
- `Printer` → `schema.prisma:L14402`
- `PrintGateway` → `schema.prisma:L14459`
- `PrintJob` → `schema.prisma:L15173`
- `PrintStation` → `schema.prisma:L14477`
...
- `PromoterBankAccount` → `schema.prisma:L16329`
- `PromoterCommissionEntry` → `schema.prisma:L16348`
- `PromoterLocationPing` → `schema.prisma:L3495`
- `Promotion` → `schema.prisma:L16623`
- `PromotionGroup` → `schema.prisma:L16662`
- `PromotionOption` → `schema.prisma:L16678`
...
- `RefreshGrant` → `schema.prisma:L17054`
...
- `SalesRetention` → `schema.prisma:L16029`
- `SaleVerification` → `schema.prisma:L4345`
- `ScaleProfile` → `schema.prisma:L14914`
...
- `StaffOnboardingState` → `schema.prisma:L15244`
...
- `VenueAreaTicketSettings` → `schema.prisma:L14651`
...
- `VenueScaleSettings` → `schema.prisma:L14902`
