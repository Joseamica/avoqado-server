...
`prisma/schema.prisma` is **222 models / 198 enums / ~10,500 lines**. Nobody reads it top to bottom. This file is the **index**: 20 domains,
...
- `CustomerTaxProfile` → `schema.prisma:L10532`
...
- `FiscalEmisor` → `schema.prisma:L10405`
...
- `McpAuthCode` → `schema.prisma:L10312`
- `McpOAuthClient` → `schema.prisma:L10296`
- `McpRefreshToken` → `schema.prisma:L10330`
...
- `MerchantFiscalConfig` → `schema.prisma:L10441`
