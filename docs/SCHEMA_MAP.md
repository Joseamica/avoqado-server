...
- `AccountingPeriodLock` → `schema.prisma:L11019`
- `AccountMapping` → `schema.prisma:L10919`
...
- `BankStatement` → `schema.prisma:L10793`
- `BankStatementLine` → `schema.prisma:L10814`
- `BillingTaxProfile` → `schema.prisma:L11508`
...
- `CashOutCommissionRate` → `schema.prisma:L11337`
- `CashOutScheduleDay` → `schema.prisma:L11360`
- `CashOutWithdrawal` → `schema.prisma:L11422`
- `Cfdi` → `schema.prisma:L10696`
...
- `CustomerTaxProfile` → `schema.prisma:L10765`
...
- `FiscalEmisor` → `schema.prisma:L10638`
...
- `JournalEntry` → `schema.prisma:L10973`
- `JournalLine` → `schema.prisma:L11001`
- `KdsOrder` → `schema.prisma:L10402`
- `KdsOrderItem` → `schema.prisma:L10419`
- `LearnedPatterns` → `schema.prisma:L6481`
- `LedgerAccount` → `schema.prisma:L10869`
...
- `McpAuthCode` → `schema.prisma:L10545`
- `McpOAuthClient` → `schema.prisma:L10529`
- `McpRefreshToken` → `schema.prisma:L10563`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L10478`
- `MerchantAccount` → `schema.prisma:L3581`
- `MerchantFiscalConfig` → `schema.prisma:L10674`
...
- `PayrollLine` → `schema.prisma:L11256`
- `PayrollRun` → `schema.prisma:L11225`
- `PerformanceGoal` → `schema.prisma:L8409`
- `PermissionSet` → `schema.prisma:L1073`
- `PlatformCfdi` → `schema.prisma:L11537`
- `PlatformEmisor` → `schema.prisma:L11481`
...
- `PromoterBankAccount` → `schema.prisma:L11376`
- `PromoterCommissionEntry` → `schema.prisma:L11395`
...
- `StaffOnboardingState` → `schema.prisma:L10448`
...
- `VenueCommission` → `schema.prisma:L10380`
