...
- `AccountingPeriodLock` → `schema.prisma:L16592`
- `AccountMapping` → `schema.prisma:L16488`
...
- `AreaTicket` → `schema.prisma:L15373`
- `AreaTicketCheckoutSession` → `schema.prisma:L15495`
- `AreaTicketExternalIncident` → `schema.prisma:L15742`
- `AreaTicketExternalSettlement` → `schema.prisma:L15707`
- `AreaTicketFulfillment` → `schema.prisma:L15571`
- `AreaTicketInventoryReservation` → `schema.prisma:L15466`
- `AreaTicketLine` → `schema.prisma:L15434`
- `AreaTicketPaymentAttempt` → `schema.prisma:L15527`
- `AreaTicketPrintAttempt` → `schema.prisma:L15550`
- `BankStatement` → `schema.prisma:L16362`
- `BankStatementLine` → `schema.prisma:L16383`
- `BillingObligationConflict` → `schema.prisma:L4666`
- `BillingTaxProfile` → `schema.prisma:L17172`
...
- `CashOutCommissionRate` → `schema.prisma:L17001`
- `CashOutScheduleDay` → `schema.prisma:L17024`
- `CashOutWithdrawal` → `schema.prisma:L17086`
...
- `CustomerTaxProfile` → `schema.prisma:L16334`
...
- `FiscalEmisor` → `schema.prisma:L16178`
- `FiscalLossCarryforward` → `schema.prisma:L16759`
- `FixedAsset` → `schema.prisma:L16777`
- `FixedAssetDepreciation` → `schema.prisma:L16806`
- `FloorElement` → `schema.prisma:L3180`
- `FulfillmentArea` → `schema.prisma:L15238`
...
- `JournalEntry` → `schema.prisma:L16546`
- `JournalLine` → `schema.prisma:L16574`
- `KdsOrder` → `schema.prisma:L15005`
- `KdsOrderItem` → `schema.prisma:L15054`
- `KioskCheckInAttempt` → `schema.prisma:L17495`
- `KioskCheckInChallenge` → `schema.prisma:L17449`
- `KioskOutreachOutbox` → `schema.prisma:L17516`
- `LaunchCampaign` → `schema.prisma:L17854`
- `LaunchCampaignRedemption` → `schema.prisma:L17960`
- `LearnedPatterns` → `schema.prisma:L9875`
- `LedgerAccount` → `schema.prisma:L16438`
...
- `McpAuthCode` → `schema.prisma:L16061`
- `McpOAuthClient` → `schema.prisma:L16045`
- `McpRefreshToken` → `schema.prisma:L16079`
- `McpToolCall` → `schema.prisma:L16100`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L15975`
- `MerchantAccount` → `schema.prisma:L5459`
- `MerchantFiscalConfig` → `schema.prisma:L16226`
...
- `OrderFulfillment` → `schema.prisma:L15293`
- `OrderFulfillmentLine` → `schema.prisma:L15324`
- `OrderItem` → `schema.prisma:L3907`
- `OrderItemModifier` → `schema.prisma:L4130`
- `OrderPromotion` → `schema.prisma:L17412`
...
- `PaymentEffect` → `schema.prisma:L17786`
...
- `PayrollLine` → `schema.prisma:L16920`
- `PayrollRun` → `schema.prisma:L16889`
- `PerformanceGoal` → `schema.prisma:L12876`
- `PermissionOverride` → `schema.prisma:L1401`
- `PermissionSet` → `schema.prisma:L1424`
- `PlatformAnnouncement` → `schema.prisma:L17576`
- `PlatformAnnouncementClick` → `schema.prisma:L17641`
- `PlatformAnnouncementDelivery` → `schema.prisma:L17678`
- `PlatformCfdi` → `schema.prisma:L17205`
- `PlatformEmisor` → `schema.prisma:L17145`
- `PlatformSettings` → `schema.prisma:L5840`
- `PosCommand` → `schema.prisma:L8805`
- `PosConnectionStatus` → `schema.prisma:L948`
- `PosSyncIntent` → `schema.prisma:L17283`
- `PricingPolicy` → `schema.prisma:L2670`
- `Printer` → `schema.prisma:L15103`
- `PrintGateway` → `schema.prisma:L15160`
- `PrintJob` → `schema.prisma:L15874`
- `PrintStation` → `schema.prisma:L15178`
...
- `PromoterBankAccount` → `schema.prisma:L17040`
- `PromoterCommissionEntry` → `schema.prisma:L17059`
- `PromoterLocationPing` → `schema.prisma:L3595`
- `Promotion` → `schema.prisma:L17334`
- `PromotionGroup` → `schema.prisma:L17373`
- `PromotionOption` → `schema.prisma:L17389`
...
- `ReceiptLayout` → `schema.prisma:L17820`
...
- `RefreshGrant` → `schema.prisma:L17765`
...
- `SalesRetention` → `schema.prisma:L16740`
- `SaleVerification` → `schema.prisma:L4508`
- `ScaleProfile` → `schema.prisma:L15615`
...
- `StaffOnboardingState` → `schema.prisma:L15945`
...
- `VenueAreaTicketSettings` → `schema.prisma:L15352`
...
- `VenueScaleSettings` → `schema.prisma:L15603`
