...
- `AccountingPeriodLock` → `schema.prisma:L14916`
- `AccountMapping` → `schema.prisma:L14812`
...
- `AreaTicket` → `schema.prisma:L13707`
- `AreaTicketCheckoutSession` → `schema.prisma:L13829`
- `AreaTicketExternalIncident` → `schema.prisma:L14076`
- `AreaTicketExternalSettlement` → `schema.prisma:L14041`
- `AreaTicketFulfillment` → `schema.prisma:L13905`
- `AreaTicketInventoryReservation` → `schema.prisma:L13800`
- `AreaTicketLine` → `schema.prisma:L13768`
- `AreaTicketPaymentAttempt` → `schema.prisma:L13861`
- `AreaTicketPrintAttempt` → `schema.prisma:L13884`
- `BankStatement` → `schema.prisma:L14686`
- `BankStatementLine` → `schema.prisma:L14707`
- `BillingTaxProfile` → `schema.prisma:L15496`
...
- `CashOutCommissionRate` → `schema.prisma:L15325`
- `CashOutScheduleDay` → `schema.prisma:L15348`
- `CashOutWithdrawal` → `schema.prisma:L15410`
...
- `CustomerTaxProfile` → `schema.prisma:L14658`
...
- `FiscalEmisor` → `schema.prisma:L14512`
- `FiscalLossCarryforward` → `schema.prisma:L15083`
- `FixedAsset` → `schema.prisma:L15101`
- `FixedAssetDepreciation` → `schema.prisma:L15130`
- `FloorElement` → `schema.prisma:L2873`
- `FulfillmentArea` → `schema.prisma:L13572`
...
- `JournalEntry` → `schema.prisma:L14870`
- `JournalLine` → `schema.prisma:L14898`
- `KdsOrder` → `schema.prisma:L13358`
- `KdsOrderItem` → `schema.prisma:L13399`
- `LearnedPatterns` → `schema.prisma:L8316`
- `LedgerAccount` → `schema.prisma:L14762`
...
- `McpAuthCode` → `schema.prisma:L14395`
- `McpOAuthClient` → `schema.prisma:L14379`
- `McpRefreshToken` → `schema.prisma:L14413`
- `McpToolCall` → `schema.prisma:L14434`
...
- `MercadoPagoWebhookEvent` → `schema.prisma:L14309`
- `MerchantAccount` → `schema.prisma:L4716`
- `MerchantFiscalConfig` → `schema.prisma:L14560`
...
- `OrderFulfillment` → `schema.prisma:L13627`
- `OrderFulfillmentLine` → `schema.prisma:L13658`
- `OrderItem` → `schema.prisma:L3328`
- `OrderItemModifier` → `schema.prisma:L3546`
- `OrderPromotion` → `schema.prisma:L15736`
...
- `PromoterBankAccount` → `schema.prisma:L15364`
- `PromoterCommissionEntry` → `schema.prisma:L15383`
- `PromoterLocationPing` → `schema.prisma:L3070`
- `Promotion` → `schema.prisma:L15658`
- `PromotionGroup` → `schema.prisma:L15697`
- `PromotionOption` → `schema.prisma:L15713`
...
- `SalesRetention` → `schema.prisma:L15064`
- `SaleVerification` → `schema.prisma:L3914`
- `ScaleProfile` → `schema.prisma:L13949`
...
- `StaffOnboardingState` → `schema.prisma:L14279`
...
- `VenueAreaTicketSettings` → `schema.prisma:L13686`
...
- `VenueScaleSettings` → `schema.prisma:L13937`
