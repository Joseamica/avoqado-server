...
- `AccountingPeriodLock` → `schema.prisma:L14902`
- `AccountMapping` → `schema.prisma:L14798`
- `ActivityLog` → `schema.prisma:L6223`
- `Aggregator` → `schema.prisma:L13213`
- `AngelPayUserAccount` → `schema.prisma:L4886`
- `AppUpdate` → `schema.prisma:L11433`
- `Area` → `schema.prisma:L2797`
- `AreaTicket` → `schema.prisma:L13693`
- `AreaTicketCheckoutSession` → `schema.prisma:L13815`
- `AreaTicketExternalIncident` → `schema.prisma:L14062`
- `AreaTicketExternalSettlement` → `schema.prisma:L14027`
- `AreaTicketFulfillment` → `schema.prisma:L13891`
- `AreaTicketInventoryReservation` → `schema.prisma:L13786`
- `AreaTicketLine` → `schema.prisma:L13754`
- `AreaTicketPaymentAttempt` → `schema.prisma:L13847`
- `AreaTicketPrintAttempt` → `schema.prisma:L13870`
- `BankStatement` → `schema.prisma:L14672`
- `BankStatementLine` → `schema.prisma:L14693`
- `BillingTaxProfile` → `schema.prisma:L15482`
- `BulkCommandOperation` → `schema.prisma:L8746`
- `CalendarSyncOutbox` → `schema.prisma:L12607`
- `CampaignDelivery` → `schema.prisma:L11591`
- `CashCloseout` → `schema.prisma:L9111`
- `CashDeposit` → `schema.prisma:L11235`
- `CashDrawerEvent` → `schema.prisma:L13050`
- `CashDrawerSession` → `schema.prisma:L13026`
- `CashOutCommissionRate` → `schema.prisma:L15311`
- `CashOutScheduleDay` → `schema.prisma:L15334`
- `CashOutWithdrawal` → `schema.prisma:L15396`
...
- `ClassSession` → `schema.prisma:L12225`
- `CommissionCalculation` → `schema.prisma:L11014`
- `CommissionClawback` → `schema.prisma:L11187`
- `CommissionConfig` → `schema.prisma:L10787`
- `CommissionMilestone` → `schema.prisma:L10930`
- `CommissionOverride` → `schema.prisma:L10857`
- `CommissionPayout` → `schema.prisma:L11138`
- `CommissionSummary` → `schema.prisma:L11077`
- `CommissionTier` → `schema.prisma:L10894`
...
- `CreditItemBalance` → `schema.prisma:L12816`
- `CreditOffer` → `schema.prisma:L9239`
- `CreditPack` → `schema.prisma:L12732`
- `CreditPackItem` → `schema.prisma:L12761`
- `CreditPackPurchase` → `schema.prisma:L12778`
- `CreditTransaction` → `schema.prisma:L12838`
- `Customer` → `schema.prisma:L6264`
- `CustomerDiscount` → `schema.prisma:L7051`
- `CustomerGroup` → `schema.prisma:L6418`
- `CustomerTaxProfile` → `schema.prisma:L14644`
...
- `EmailTemplate` → `schema.prisma:L11530`
- `Employee` → `schema.prisma:L15159`
- `Estimate` → `schema.prisma:L13120`
- `EstimateItem` → `schema.prisma:L13148`
- `Expense` → `schema.prisma:L14946`
- `ExternalBusyBlock` → `schema.prisma:L12500`
- `Feature` → `schema.prisma:L4010`
- `FeeSchedule` → `schema.prisma:L4088`
- `FeeTier` → `schema.prisma:L4099`
- `FinancialAccount` → `schema.prisma:L13310`
- `FinancialConnection` → `schema.prisma:L13279`
- `FinancialProvider` → `schema.prisma:L13265`
- `FiscalEmisor` → `schema.prisma:L14498`
- `FiscalLossCarryforward` → `schema.prisma:L15069`
- `FixedAsset` → `schema.prisma:L15087`
- `FixedAssetDepreciation` → `schema.prisma:L15116`
- `FloorElement` → `schema.prisma:L2873`
- `FulfillmentArea` → `schema.prisma:L13558`
- `GeofenceRule` → `schema.prisma:L8831`
- `GoogleCalendarChannel` → `schema.prisma:L12477`
- `GoogleCalendarConnection` → `schema.prisma:L12429`
- `GoogleCalendarWebhookInbox` → `schema.prisma:L12530`
- `GoogleOAuthSession` → `schema.prisma:L12552`
- `HolidayCalendar` → `schema.prisma:L6147`
- `IdempotencyRequest` → `schema.prisma:L10662`
...
- `InventoryTransfer` → `schema.prisma:L13092`
...
- `JournalEntry` → `schema.prisma:L14856`
- `JournalLine` → `schema.prisma:L14884`
- `KdsOrder` → `schema.prisma:L13358`
- `KdsOrderItem` → `schema.prisma:L13399`
- `LearnedPatterns` → `schema.prisma:L8316`
- `LedgerAccount` → `schema.prisma:L14748`
...
- `MarketingCampaign` → `schema.prisma:L11548`
- `McpAuthCode` → `schema.prisma:L14381`
- `McpOAuthClient` → `schema.prisma:L14365`
- `McpRefreshToken` → `schema.prisma:L14399`
- `McpToolCall` → `schema.prisma:L14420`
- `MeasurementUnit` → `schema.prisma:L13198`
- `Menu` → `schema.prisma:L1552`
- `MenuCategory` → `schema.prisma:L1489`
- `MenuCategoryAssignment` → `schema.prisma:L1587`
- `MercadoPagoWebhookEvent` → `schema.prisma:L14295`
- `MerchantAccount` → `schema.prisma:L4716`
- `MerchantFiscalConfig` → `schema.prisma:L14546`
- `MerchantRevenueShare` → `schema.prisma:L5727`
- `MerchantRoutingRule` → `schema.prisma:L4838`
- `MilestoneAchievement` → `schema.prisma:L10975`
...
- `OrderFulfillment` → `schema.prisma:L13613`
- `OrderFulfillmentLine` → `schema.prisma:L13644`
- `OrderItem` → `schema.prisma:L3328`
- `OrderItemModifier` → `schema.prisma:L3546`
- `OrderPromotion` → `schema.prisma:L15722`
- `OrderServiceCharge` → `schema.prisma:L7167`
- `Organization` → `schema.prisma:L18`
- `OrganizationAttendanceConfig` → `schema.prisma:L11349`
- `OrganizationEntitlement` → `schema.prisma:L9570`
- `OrganizationGoal` → `schema.prisma:L11307`
- `OrganizationModule` → `schema.prisma:L9347`
- `OrganizationPaymentConfig` → `schema.prisma:L5290`
- `OrganizationPayoutConfig` → `schema.prisma:L11382`
- `OrganizationPricingStructure` → `schema.prisma:L5322`
- `OrganizationSalesGoalConfig` → `schema.prisma:L11330`
...
- `PaymentLink` → `schema.prisma:L12884`
- `PaymentLinkAttribution` → `schema.prisma:L12992`
- `PaymentLinkItem` → `schema.prisma:L12947`
- `PaymentLinkItemModifier` → `schema.prisma:L12974`
- `PaymentProvider` → `schema.prisma:L4675`
- `PayrollLine` → `schema.prisma:L15230`
- `PayrollRun` → `schema.prisma:L15199`
- `PerformanceGoal` → `schema.prisma:L11284`
- `PermissionOverride` → `schema.prisma:L1294`
- `PermissionSet` → `schema.prisma:L1317`
- `PlatformCfdi` → `schema.prisma:L15515`
- `PlatformEmisor` → `schema.prisma:L15455`
- `PlatformSettings` → `schema.prisma:L5097`
- `PosCommand` → `schema.prisma:L7350`
- `PosConnectionStatus` → `schema.prisma:L877`
- `PosSyncIntent` → `schema.prisma:L15593`
- `PricingPolicy` → `schema.prisma:L2370`
- `Printer` → `schema.prisma:L13441`
- `PrintGateway` → `schema.prisma:L13494`
- `PrintJob` → `schema.prisma:L14194`
- `PrintStation` → `schema.prisma:L13512`
...
- `ProductOption` → `schema.prisma:L13175`
- `ProductOptionValue` → `schema.prisma:L13186`
- `ProductStaff` → `schema.prisma:L12140`
- `PromoterBankAccount` → `schema.prisma:L15350`
- `PromoterCommissionEntry` → `schema.prisma:L15369`
- `PromoterLocationPing` → `schema.prisma:L3070`
- `Promotion` → `schema.prisma:L15644`
- `PromotionGroup` → `schema.prisma:L15683`
- `PromotionOption` → `schema.prisma:L15699`
...
- `Reservation` → `schema.prisma:L11927`
- `ReservationGoogleEventMapping` → `schema.prisma:L12664`
- `ReservationModifier` → `schema.prisma:L12088`
- `ReservationReminderSent` → `schema.prisma:L12071`
- `ReservationSettings` → `schema.prisma:L12302`
- `ReservationWaitlistEntry` → `schema.prisma:L12270`
- `Review` → `schema.prisma:L4155`
- `SalesRetention` → `schema.prisma:L15050`
- `SaleVerification` → `schema.prisma:L3914`
- `ScaleProfile` → `schema.prisma:L13935`
- `ScheduledCommand` → `schema.prisma:L8791`
- `SerializedItem` → `schema.prisma:L10421`
- `SerializedItemCustodyEvent` → `schema.prisma:L10585`
...
- `SimRegistrationRequest` → `schema.prisma:L10623`
- `SimRegistrationRequestItem` → `schema.prisma:L10645`
- `SlotHold` → `schema.prisma:L12171`
- `Staff` → `schema.prisma:L897`
- `StaffOnboardingState` → `schema.prisma:L14265`
- `StaffOrganization` → `schema.prisma:L1193`
- `StaffPasskey` → `schema.prisma:L1220`
- `StaffSchedule` → `schema.prisma:L12111`
- `StaffScheduleException` → `schema.prisma:L12123`
- `StaffVenue` → `schema.prisma:L1123`
- `StockAlertConfig` → `schema.prisma:L11266`
...
- `TpvMessage` → `schema.prisma:L11623`
- `TpvMessageDelivery` → `schema.prisma:L11675`
- `TpvMessageResponse` → `schema.prisma:L11698`
- `TrainingModule` → `schema.prisma:L11753`
- `TrainingProgress` → `schema.prisma:L11830`
- `TrainingQuizQuestion` → `schema.prisma:L11812`
- `TrainingStep` → `schema.prisma:L11792`
