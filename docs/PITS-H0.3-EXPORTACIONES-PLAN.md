...
POS\", columna \"a.Avoqado_Cumplimiento en forma natural del sistema\" = 1): Función = \"El sistema puede generar una bitacora de las
...
OWNER (y SUPERADMIN vía _:_): NO ADMIN, NO MANAGER. Usar el MISMO permiso que el listado, igual que pagos/órdenes ('quien puede ver la lista
...
Defaults: MANAGER :761, ADMIN via 'inventory:_' :907, OWNER via 'inventory:_' :1014, SUPERADMIN '_:_'. Mismo permiso que el listado (quien
