---
title: Configurar reservaciones avanzadas
description: Revisa comunicaciones, invitaciones a clientes y widget avanzado de reservaciones.
product: dashboard
...
1. Abre **Reservaciones > Ajustes** para confirmar reglas base de capacidad, horarios y disponibilidad.
2. Revisa **Comunicaciones** cuando la pantalla este disponible para controlar mensajes relacionados con reservas.
3. Entra a **Reservas online > Invitar clientes** si el local tiene habilitado el flujo de invitaciones.
4. Usa **Widget avanzado** para revisar opciones de personalizacion o instalacion cuando este habilitado.
5. Valida cualquier cambio con una reservacion de prueba antes de publicarlo.
6. Avisa al equipo de host o gerencia si cambia un mensaje, canal o forma de reservar.
