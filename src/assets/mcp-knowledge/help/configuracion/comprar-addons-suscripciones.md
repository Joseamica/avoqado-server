---
title: Comprar add-ons y suscripciones
description: Revisa facturacion, suscripciones y add-ons como Reservaciones.
product: dashboard
...
1. Abre **Configuracion > Facturacion y add-ons**.
2. Revisa plan actual, suscripciones activas y metodos de pago.
3. Identifica el add-on que quieres activar, por ejemplo **Reservaciones**.
4. Revisa precio, alcance, condiciones y sucursal donde se aplicara.
5. Confirma la compra solo cuando el responsable del negocio la haya aprobado.
6. Despues de activar, entra al modulo correspondiente para terminar la configuracion operativa.
