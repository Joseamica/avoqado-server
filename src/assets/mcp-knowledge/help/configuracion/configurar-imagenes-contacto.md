---
title: Configurar imagenes y contacto del local
description: Actualiza informacion basica, datos de contacto e imagenes visibles del local.
product: dashboard
...
1. Abre **Configuracion > Editar Local > Informacion basica**.
2. Revisa nombre del local, direccion, ciudad, telefono, correo y cualquier dato fiscal u operativo disponible en esa pantalla.
3. Guarda cambios pequenos uno por uno si estas corrigiendo informacion sensible.
4. Entra a **Configuracion > Editar Local > Imagenes y contacto**.
5. Actualiza logo, imagen principal o fotos del local segun lo que permita la pantalla.
6. Revisa que los datos de contacto coincidan con los canales donde el equipo atiende clientes.
7. Guarda y valida la informacion desde otra sesion o con otro usuario si el cambio afecta canales publicos.
