...
1. Entra al Dashboard y abre **Inicio**.
2. Confirma la sucursal activa.
3. Revisa los indicadores principales del periodo: ventas, pedidos, pagos recientes y actividad operativa.
4. Usa acciones rapidas para ir a ventas, menu, terminales o configuracion.
5. Cambia el periodo si quieres comparar contra otro dia o semana.
6. Si un numero no coincide con lo esperado, abre el reporte o listado de origen antes de asumir que hay un error.
