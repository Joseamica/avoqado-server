...
export const MOVEMENT_TYPES: MovementTypeDef[] = [
  ...
  {
    movementType: 'DEPRECIATION_EXPENSE',
    label: 'Depreciación del ejercicio (gasto)',
    defaultCode: '601.86',
    side: 'DEBIT',
    group: 'COSTOS_GASTOS',
  },
  {
    movementType: 'ACCUMULATED_DEPRECIATION',
    label: 'Depreciación acumulada (contra-activo)',
    defaultCode: '171.09',
    side: 'CREDIT',
    group: 'COSTOS_GASTOS',
  },
