 ...
 */
export async function getOrders(venueId: string, _orgId?: string): Promise<Order[]> {
 ...
 */
export async function getOrder(venueId: string, orderId: string, _orgId?: string): Promise<Order & { amount_left: number }> {
