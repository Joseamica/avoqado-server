...
export async function updateVenue(orgId: string, venueId: string, updateData: any, options?: { skipOrgCheck?: boolean }): Promise<Venue> {
  ...
  const venueUpdateData: any = {
    ...
    state: safeUpdateData.state,
    country: safeUpdateData.country,
    zipCode: safeUpdateData.zipCode,
    latitude: safeUpdateData.latitude !== undefined ? safeUpdateData.latitude : undefined,
    longitude: safeUpdateData.longitude !== undefined ? safeUpdateData.longitude : undefined,
