...
export async function listSaleVerifications(req: Request, res: Response): Promise<void> {
  try {
    ...
    logger.info(
      `[SALE VERIFICATION DASHBOARD CONTROLLER] GET /dashboard/venues/${venueId}/sale-verifications`,
    )
...
export async function getSaleVerificationsSummary(req: Request, res: Response): Promise<void> {
  try {
    ...
    logger.info(
      `[SALE VERIFICATION DASHBOARD CONTROLLER] GET /dashboard/venues/${venueId}/sale-verifications/summary`,
    )
...
export async function getDailySalesData(req: Request, res: Response): Promise<void> {
  try {
    ...
    logger.info(
      `[SALE VERIFICATION DASHBOARD CONTROLLER] GET /dashboard/venues/${venueId}/sale-verifications/daily`,
    )
...
export async function getStaffWithVerifications(req: Request, res: Response): Promise<void> {
  try {
    ...
    logger.info(
      `[SALE VERIFICATION DASHBOARD CONTROLLER] GET /dashboard/venues/${venueId}/sale-verifications/staff`,
    )
