 ...
 */
router.get('/summary', authenticateTokenMiddleware, async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/items', authenticateTokenMiddleware, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { venueId } = (req as any).authContext
 ...
 */
router.get('/recent-sales', authenticateTokenMiddleware, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { venueId } = (req as any).authContext
