...
import { NODE_ENV, COOKIE_SECRET, BODY_JSON_LIMIT, BODY_URLENCODED_LIMIT, CORS_PREVIEW_ORIGINS } from './env'
...
export const configureCoreMiddlewares = (app: Express) => {
  ...
  // CORS configuration
  app.use(cors(getCorsConfig(NODE_ENV as Environment, CORS_PREVIEW_ORIGINS)))
