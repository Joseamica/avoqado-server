...
const cardRates = z.object({
  ...
  INTERNATIONAL: z
    .number()
    .min(0, 'La tasa internacional no puede ser negativa')
    .max(1, 'La tasa internacional debe ser ≤ 1'),
})
...
export const updateMerchantRevenueShareSchema = createMerchantRevenueShareSchema
  .partial()
  .omit({ merchantAccountId: true })
