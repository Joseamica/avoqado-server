...
// NOTE: Per-step body validation is handled in the controller (saveV2Step)
// since the route uses a single generic endpoint for all steps.
// The controller validates critical fields per step number.
